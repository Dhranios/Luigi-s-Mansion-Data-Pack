...
execute if entity @s[type=minecraft:villager,tag=e_gadd,tag=underground_lab] if entity @a[advancements={luigis_mansion:lab/underground_lab=false},limit=1] run function luigis_mansion:dialog/e_gadd/underground_lab/first_entrance
