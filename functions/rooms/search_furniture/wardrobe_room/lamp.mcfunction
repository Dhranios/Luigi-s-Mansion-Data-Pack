...
execute as @e[type=minecraft:area_effect_cloud,tag=wardrobe_room,tag=random_chance,tag=selected,tag=nothing] run particle minecraft:dust 0.5 0.5 0.5 2 678.0 118.0 29.0 2 0.5 2 1 40
...
execute positioned ~ ~-1 ~ if entity @e[tag=boo,distance=..0.7] run particle minecraft:dust 1 1 1 2 678.0 118.0 29.0 2 0.5 2 1 40
