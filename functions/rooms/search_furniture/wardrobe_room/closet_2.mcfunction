...
execute as @e[type=minecraft:area_effect_cloud,tag=wardrobe_room,tag=random_chance,tag=selected,tag=nothing] run particle minecraft:dust 0.5 0.5 0.5 2 675.5 113.5 29.0 1 1 1 1 20
...
execute positioned ~ ~-1 ~ if entity @e[tag=boo,distance=..0.7] run particle minecraft:dust 1 1 1 2 675.5 113.5 29.0 1 1 1 1 20
