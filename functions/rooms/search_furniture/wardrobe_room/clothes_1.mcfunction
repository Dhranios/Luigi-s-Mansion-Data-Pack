execute positioned ~ ~-1 ~ unless entity @e[tag=boo,distance=..0.7] run particle minecraft:dust 0.5 0.5 0.5 2 674.5 115.4 33.0 0.5 1 1 1 20
...
execute positioned ~ ~-1 ~ if entity @e[tag=boo,distance=..0.7] run particle minecraft:dust 1 1 1 2 674.5 115.4 33.0 0.5 1 1 1 20
