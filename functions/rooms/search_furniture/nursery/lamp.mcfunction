execute positioned ~ ~-1 ~ unless entity @e[tag=boo,distance=..0.7] run summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"Random Chance\"}",Tags:["random_chance","money","nursery"],Duration:1}
...
execute as @e[type=minecraft:area_effect_cloud,tag=nursery,tag=random_chance,tag=selected,tag=money] if block 713 110 49 minecraft:command_block{auto:1b} run particle minecraft:dust 0.5 0.5 0.5 2 713.5 117.0 49.5 1.5 1 1.5 20
...
execute as @e[type=minecraft:area_effect_cloud,tag=nursery,tag=random_chance,tag=selected,tag=nothing] run particle minecraft:dust 0.5 0.5 0.5 2 713.5 117.0 49.5 1.5 1 1.5 20
...
execute positioned ~ ~-1 ~ if entity @e[tag=boo,distance=..0.7] run particle minecraft:dust 1 1 1 2 713.5 117.0 49.5 1.5 1.5 1 20
