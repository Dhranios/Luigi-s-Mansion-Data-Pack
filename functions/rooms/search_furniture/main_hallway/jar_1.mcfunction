...
summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"Random Chance\"}",Tags:["random_chance","money","main_hallway"],Duration:1}
...
execute as @e[type=minecraft:area_effect_cloud,tag=main_hallway,tag=random_chance,tag=selected,tag=money] if block 700 100 32 minecraft:command_block{auto:1b} run particle minecraft:dust 0.5 0.5 0.5 2 700.5 103.5 32.5 0.5 0.5 0.5 20
execute as @e[type=minecraft:area_effect_cloud,tag=main_hallway,tag=random_chance,tag=selected,tag=money] run data merge block 700 100 32 {auto:1b}
execute as @e[type=minecraft:area_effect_cloud,tag=main_hallway,tag=random_chance,tag=selected,tag=nothing] run particle minecraft:dust 0.5 0.5 0.5 2 700.5 103.5 32.5 0.5 0.5 0.5 20
