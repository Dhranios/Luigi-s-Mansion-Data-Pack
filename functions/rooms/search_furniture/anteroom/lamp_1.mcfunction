...
execute as @e[type=minecraft:area_effect_cloud,tag=anteroom,tag=random_chance,tag=selected,tag=money] if block 678 110 11 minecraft:command_block{auto:1b} run particle minecraft:dust 0.5 0.5 0.5 2 678.5 117.0 11.5 1.5 1 1.5 1 40
...
execute as @e[type=minecraft:area_effect_cloud,tag=anteroom,tag=random_chance,tag=selected,tag=nothing] run particle minecraft:dust 0.5 0.5 0.5 2 678.5 117.0 11.5 1.5 1 1.5 1 40
...
execute positioned ~ ~-1 ~ if entity @e[tag=boo,distance=..0.7] run particle minecraft:dust 1 1 1 2 678.5 117.0 11.5 1.5 1 1.5 40
