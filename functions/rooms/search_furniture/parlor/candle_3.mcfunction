execute positioned ~ ~-1 ~ unless entity @e[tag=boo,distance=..0.7] run particle minecraft:dust 0.5 0.5 0.5 2 691.5 113.5 3.5 0.5 0.5 0.5 20
...
execute positioned ~ ~-1 ~ if entity @e[tag=boo,distance=..0.7] run particle minecraft:dust 1 1 1 2 691.5 113.5 3.5 0.5 0.5 0.5 20
