...
execute if entity @s[tag=boos_released] if block 678 103 -25 minecraft:spruce_log run clone 674 102 -26 681 108 -25 674 102 -14 masked move
...
execute if entity @s[advancements={luigis_mansion:mansion/storage_room=true}] unless entity @s[advancements={luigis_mansion:mansion/breaker_room=false},tag=blackout] if block 675 105 -13 minecraft:air if block 675 105 -14 minecraft:redstone_lamp run setblock 675 105 -13 minecraft:stone_button[face=floor,powered=true,facing=north]
execute if entity @s[advancements={luigis_mansion:mansion/storage_room=true}] unless entity @s[advancements={luigis_mansion:mansion/breaker_room=false},tag=blackout] if block 680 105 -13 minecraft:air if block 680 105 -14 minecraft:redstone_lamp run setblock 680 105 -13 minecraft:stone_button[face=floor,powered=true,facing=north]
