...
execute if entity @s[advancements={luigis_mansion:mansion/graveyard=false}] if block 702 108 23 minecraft:stone_button run setblock 702 108 23 minecraft:air
...
execute if entity @s[advancements={luigis_mansion:mansion/breaker_room=false},tag=blackout] if block 702 108 23 minecraft:stone_button run setblock 702 108 23 minecraft:air
...
execute if entity @e[x=700,y=103,z=32,dx=1,dy=1.5,dz=1,tag=poltergust,limit=1] run data merge block 700 100 32 {auto:1b}
execute if entity @e[x=700,y=103,z=32,dx=1,dy=1.5,dz=1,tag=poltergust,limit=1] run data merge block 700 100 31 {auto:1b}
execute if entity @e[x=700,y=103,z=-16,dx=1,dy=1.5,dz=1,tag=poltergust,limit=1] run data merge block 700 100 -16 {auto:1b}
