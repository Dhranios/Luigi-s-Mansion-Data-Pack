...
execute if entity @s[tag=!room_name,advancements={luigis_mansion:key/main_hallway=true}] run kill @e[tag=foyer,tag=door_blockade]
...
execute if entity @s[advancements={luigis_mansion:lab/training_room=true,luigis_mansion:money/foyer/enter=false}] run function luigis_mansion:rooms/money/foyer/enter
