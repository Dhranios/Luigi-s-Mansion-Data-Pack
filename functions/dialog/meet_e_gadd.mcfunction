...
execute if entity @s[scores={Dialog=1}] run setblock 686 114 9 minecraft:brewing_stand[has_bottle_0=false,has_bottle_1=false,has_bottle_2=false]{CustomName:"{\"translate\":\"luigis_mansion:block.brewing_stand.candle_stand\"}",Items:[]}
execute if entity @s[scores={Dialog=1}] run setblock 686 114 6 minecraft:brewing_stand[has_bottle_0=false,has_bottle_1=false,has_bottle_2=false]{CustomName:"{\"translate\":\"luigis_mansion:block.brewing_stand.candle_stand\"}",Items:[]}
...
execute if entity @s[scores={Dialog=500}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.1"}]}
execute if entity @s[scores={Dialog=580}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.2"}]}
teleport @s[scores={Dialog=580}] ~ ~ ~ 110 0
execute if entity @s[scores={Dialog=680}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.3"}]}
execute if entity @s[scores={Dialog=780}] run tellraw @a[tag=single] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.4"}]}
execute if entity @s[scores={Dialog=780}] run tellraw @a[tag=more] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.4.more"}]}
execute if entity @s[scores={Dialog=780}] run tellraw @a[tag=even_more] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.4.more"}]}
teleport @s[scores={Dialog=880}] ~ ~ ~ 0 0
teleport @s[scores={Dialog=881..1080}] ~ ~ ~ ~0.45 0
execute if entity @s[scores={Dialog=880}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.5"}]}
execute if entity @s[scores={Dialog=980}] run tellraw @a[tag=single] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.6"}]}
execute if entity @s[scores={Dialog=980}] run tellraw @a[tag=more] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.6.more"}]}
execute if entity @s[scores={Dialog=980}] run tellraw @a[tag=even_more] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.6.more"}]}
...
execute if entity @s[scores={Dialog=1210}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.7"}]}
execute if entity @s[scores={Dialog=1210..1340}] as @e[type=minecraft:zombie,tag=parlor] at @s run teleport @s ~0.025 ~ ~ -90 0
execute if entity @s[scores={Dialog=1250}] run tellraw @a[tag=single] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.8"}]}
execute if entity @s[scores={Dialog=1250}] run tellraw @a[tag=more] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.8.more"}]}
execute if entity @s[scores={Dialog=1250}] run tellraw @a[tag=even_more] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd"},{"translate":"luigis_mansion:message.e_gadd.meet_e_gadd.8.more"}]}
