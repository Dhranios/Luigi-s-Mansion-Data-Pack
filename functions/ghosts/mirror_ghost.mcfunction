execute if entity @s[scores={SpawnedTime=2}] run playsound luigis_mansion:entity.mirror_ghost.spawn hostile @a ~ ~ ~ 1
...
execute if entity @s[scores={VulnerableTime=..0}] as @a[distance=..2,gamemode=adventure,tag=!grabbed] run playsound luigis_mansion:entity.mirror_ghost.grab hostile @a ~ ~ ~ 1
...
data merge entity @s[scores={VulnerableTime=2..}] {ArmorItems:[{},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{Unbreakable:1b,AttributeModifiers:[],display:{color:38655}}},{id:"minecraft:leather_helmet",Count:1b,tag:{Unbreakable:1b,AttributeModifiers:[],display:{color:38655}}}]}
execute at @a[gamemode=adventure] run data merge entity @s[distance=..2] {ArmorItems:[{},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{Unbreakable:1b,AttributeModifiers:[],display:{color:38655}}},{id:"minecraft:leather_helmet",Count:1b,tag:{Unbreakable:1b,AttributeModifiers:[],display:{color:38655}}}]}
...
execute if entity @s[tag=dead] run playsound luigis_mansion:entity.mirror_ghost.vacumed hostile @a ~ ~ ~ 1
execute if entity @s[tag=hurt] run playsound luigis_mansion:entity.mirror_ghost.hurt hostile @a ~ ~ ~ 1