execute if entity @s[scores={SpawnedTime=2}] run playsound luigis_mansion:entity.red_grabbing_ghost.spawn hostile @a ~ ~ ~ 1
...
execute if entity @s[scores={VulnerableTime=..0}] as @a[distance=..2,gamemode=adventure,tag=!grabbed] run playsound luigis_mansion:entity.red_grabbing_ghost.grab hostile @a ~ ~ ~ 1
...
execute if entity @s[tag=dead] run playsound luigis_mansion:entity.red_grabbing_ghost.vacumed hostile @a ~ ~ ~ 1
execute if entity @s[tag=hurt] run playsound luigis_mansion:entity.red_grabbing_ghost.hurt hostile @a ~ ~ ~ 1