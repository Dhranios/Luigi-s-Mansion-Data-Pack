...
execute unless score #bogmire LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #bogmire LastHealth 10000
execute unless score #bogmire LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #bogmire LastHealth 15000
