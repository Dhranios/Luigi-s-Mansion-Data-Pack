...
execute unless score #neville LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #neville LastHealth 10000
execute unless score #neville LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #neville LastHealth 15000
scoreboard players operation @e[tag=this_entity,limit=1] Health = #neville LastHealth
