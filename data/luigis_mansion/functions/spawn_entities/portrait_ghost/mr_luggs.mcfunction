...
execute unless score #mr_luggs LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #mr_luggs LastHealth 10000
execute unless score #mr_luggs LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #mr_luggs LastHealth 15000
