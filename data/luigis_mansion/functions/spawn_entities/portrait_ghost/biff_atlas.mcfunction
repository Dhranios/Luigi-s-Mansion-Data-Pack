...
execute unless score #biff_atlas LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #biff_atlas LastHealth 10000
execute unless score #biff_atlas LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #biff_atlas LastHealth 15000
