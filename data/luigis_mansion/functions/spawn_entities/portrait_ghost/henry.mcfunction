...
execute unless score #henry LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #henry LastHealth 10000
execute unless score #henry LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #henry LastHealth 15000
scoreboard players operation @e[tag=this_entity,limit=1] Health = #henry LastHealth
