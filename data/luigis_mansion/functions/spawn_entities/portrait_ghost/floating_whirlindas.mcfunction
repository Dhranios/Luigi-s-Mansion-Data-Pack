...
execute unless score #floating_whirlindas LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #floating_whirlindas LastHealth 10000
execute unless score #floating_whirlindas LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #floating_whirlindas LastHealth 15000
