...
execute unless score #pink_clockwork_soldier LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #pink_clockwork_soldier LastHealth 10000
execute unless score #pink_clockwork_soldier LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #pink_clockwork_soldier LastHealth 15000
scoreboard players operation @e[tag=this_entity,limit=1] Health = #pink_clockwork_soldier LastHealth
