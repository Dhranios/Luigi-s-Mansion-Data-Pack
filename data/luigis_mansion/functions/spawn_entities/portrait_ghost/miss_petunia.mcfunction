...
execute unless score #miss_petunia LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #miss_petunia LastHealth 10000
execute unless score #miss_petunia LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #miss_petunia LastHealth 15000
