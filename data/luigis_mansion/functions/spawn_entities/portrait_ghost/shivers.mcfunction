...
execute unless score #shivers LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #shivers LastHealth 10000
execute unless score #shivers LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #shivers LastHealth 15000
