...
execute unless score #king_boo LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #king_boo LastHealth 50000
execute unless score #king_boo LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #king_boo LastHealth 75000
