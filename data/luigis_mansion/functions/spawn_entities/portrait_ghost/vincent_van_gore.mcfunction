...
execute unless score #vincent_van_gore LastHealth matches 1.. if score #extra_health Selected matches 0 run scoreboard players set #vincent_van_gore LastHealth 10000
execute unless score #vincent_van_gore LastHealth matches 1.. if score #extra_health Selected matches 1 run scoreboard players set #vincent_van_gore LastHealth 15000
