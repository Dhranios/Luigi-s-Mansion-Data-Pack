summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"translate":"luigis_mansion:entity.ice_spike"}',CustomNameVisible:0b,Invisible:1b,Invulnerable:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:ice",Count:1b}],Silent:1b,Pose:{RightArm:[0.0f,0.0f,0.0f],LeftArm:[0.0f,0.0f,0.0f],Head:[0.0f,0.0f,0.0f]},LeftHanded:1b,Team:"Ghosts",Tags:["ice_spike","optional_ghost","this_entity"],DisabledSlots:2039583}
