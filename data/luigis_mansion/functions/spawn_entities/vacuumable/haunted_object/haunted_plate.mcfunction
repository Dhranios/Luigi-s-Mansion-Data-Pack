summon minecraft:armor_stand ~ ~-0.45 ~ {CustomName:'{"translate":"luigis_mansion:entity.haunted_plate"}',Invisible:1b,NoGravity:1b,CustomNameVisible:1b,Invulnerable:0b,Small:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:100}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["haunted_object","vacuumable","haunted_plate","optional_ghost","this_entity"],DisabledSlots:2039583}
