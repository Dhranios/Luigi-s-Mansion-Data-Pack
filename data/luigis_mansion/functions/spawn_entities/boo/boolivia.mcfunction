...
execute unless score #boolivia LastHealth matches 1.. run scoreboard players set #boolivia LastHealth 10000
scoreboard players operation @e[tag=this_entity,limit=1] Health = #boolivia LastHealth
scoreboard players operation @e[tag=this_entity,limit=1] Room = #boolivia Room
