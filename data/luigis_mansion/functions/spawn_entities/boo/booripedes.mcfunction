...
execute unless score #booripedes LastHealth matches 1.. run scoreboard players set #booripedes LastHealth 10000
scoreboard players operation @e[tag=this_entity,limit=1] Health = #booripedes LastHealth
scoreboard players operation @e[tag=this_entity,limit=1] Room = #booripedes Room
