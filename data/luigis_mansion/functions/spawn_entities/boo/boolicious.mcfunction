...
execute unless score #boolicious LastHealth matches 1.. run scoreboard players set #boolicious LastHealth 3000
scoreboard players operation @e[tag=this_entity,limit=1] Health = #boolicious LastHealth
scoreboard players operation @e[tag=this_entity,limit=1] Room = #boolicious Room
