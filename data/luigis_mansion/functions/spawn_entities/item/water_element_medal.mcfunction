summon minecraft:armor_stand ~ ~-1 ~ {Pose:{Head:[0.0f,0.0f,0.01f]},Marker:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:5,CustomModelData:24}}],Tags:["item","element_medal","water","this_entity"],DisabledSlots:2039583}
