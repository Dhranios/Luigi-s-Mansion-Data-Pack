...
execute store result score #temp Bowling run data get entity @s Pose.Head[0]
execute store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Bowling 5
