...
execute if entity @s[scores={ActionTime=..99},tag=new_leader] if score #mirrored Selected matches 1 rotated ~5.4 ~ positioned ^ ^ ^-0.5 rotated as @s run teleport @s ~ ~ ~ ~-5.4 ~
execute if entity @s[scores={ActionTime=..99},tag=new_leader] if score #mirrored Selected matches 1 rotated ~5.4 ~ positioned ^ ^ ^0.5 as @e[tag=partner,limit=1] rotated as @s run teleport @s ~ ~ ~ ~-5.4 ~
execute if entity @s[scores={ActionTime=1}] run playsound luigis_mansion:entity.ghost_guy.dance hostile @a ~ ~ ~ 1
execute if entity @s[scores={ActionTime=14}] run playsound luigis_mansion:entity.ghost_guy.dance hostile @a ~ ~ ~ 1
execute if entity @s[scores={ActionTime=27}] run playsound luigis_mansion:entity.ghost_guy.dance hostile @a ~ ~ ~ 1
execute if entity @s[scores={ActionTime=40}] run playsound luigis_mansion:entity.ghost_guy.dance hostile @a ~ ~ ~ 1
execute if entity @s[scores={ActionTime=53}] run playsound luigis_mansion:entity.ghost_guy.dance hostile @a ~ ~ ~ 1
execute if entity @s[scores={ActionTime=66}] run playsound luigis_mansion:entity.ghost_guy.dance hostile @a ~ ~ ~ 1
execute if entity @s[scores={ActionTime=79}] run playsound luigis_mansion:entity.ghost_guy.dance hostile @a ~ ~ ~ 1
