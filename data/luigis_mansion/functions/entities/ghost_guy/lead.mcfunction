...
execute if entity @s[scores={Time=..99},tag=!new_leader] rotated ~5.4 ~ positioned ^ ^ ^-0.5 rotated as @s run teleport @s ~ ~ ~ ~5.4 ~
execute if entity @s[scores={Time=..99},tag=!new_leader] rotated ~5.4 ~ positioned ^ ^ ^0.5 as @e[tag=partner,limit=1] rotated as @s run teleport @s ~ ~ ~ ~5.4 ~
execute if entity @s[scores={Time=..99},tag=new_leader] rotated ~-5.4 ~ positioned ^ ^ ^-0.5 rotated as @s run teleport @s ~ ~ ~ ~-5.4 ~
execute if entity @s[scores={Time=..99},tag=new_leader] rotated ~-5.4 ~ positioned ^ ^ ^0.5 as @e[tag=partner,limit=1] rotated as @s run teleport @s ~ ~ ~ ~-5.4 ~
