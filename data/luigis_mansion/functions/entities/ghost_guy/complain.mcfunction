...
execute if entity @s[scores={AnimationProg=1}] run playsound luigis_mansion:entity.ghost_guy.complain hostile @a ~ ~ ~ 1
...
tag @s[scores={AnimationProg=60},tag=!maskless] remove complain
tag @s[scores={AnimationProg=60},tag=maskless] add disappear
