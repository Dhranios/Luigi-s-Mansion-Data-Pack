...
data merge entity @s[scores={ActionTime=1}] {Pose:{RightArm:[-70.0f,0.0f,0.0f],LeftArm:[-70.0f,0.0f,0.0f],Head:[10.0f,0.0f,0.0f]}}
function luigis_mansion:animations/ghost_guy/complain
data merge entity @s[scores={ActionTime=40}] {Pose:{RightArm:[-90.0f,90.0f,0.0f],LeftArm:[-90.0f,-90.0f,0.0f],Head:[0.0f,0.0f,0.0f]}}
