...
execute if entity @s[x=694.5,y=102,z=-30.5,distance=..0.7,scores={PathStep=1}] run scoreboard players set @s PathStep 2
execute if entity @s[x=687.5,y=102,z=-30.5,distance=..0.7,scores={PathStep=2}] run scoreboard players set @s PathStep 3
execute if entity @s[x=687.5,y=102,z=-35.5,distance=..0.7,scores={PathStep=3}] run scoreboard players set @s PathStep 4
execute if entity @s[x=687.5,y=102,z=-30.5,distance=..0.7,scores={PathStep=4}] run scoreboard players set @s PathStep 5
execute if entity @s[x=694.5,y=102,z=-30.5,distance=..0.7,scores={PathStep=5}] run scoreboard players set @s PathStep 6
execute if entity @s[x=694.5,y=102,z=-35.5,distance=..0.7,scores={PathStep=6}] run scoreboard players set @s PathStep 1
