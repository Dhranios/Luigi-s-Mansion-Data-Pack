...
execute if score ghost_guys_1 Wave matches 1 run summon minecraft:area_effect_cloud 687 102 -21 {Tags:["target"],Duration:1}
execute if score ghost_guys_1 Wave matches 2 run summon minecraft:area_effect_cloud 694 102 -21 {Tags:["target"],Duration:1}
execute if score ghost_guys_1 Wave matches 3 run summon minecraft:area_effect_cloud 694 102 -16 {Tags:["target"],Duration:1}
execute if score ghost_guys_1 Wave matches 4 run summon minecraft:area_effect_cloud 694 102 -21 {Tags:["target"],Duration:1}
execute if score ghost_guys_1 Wave matches 5 run summon minecraft:area_effect_cloud 687 102 -21 {Tags:["target"],Duration:1}
execute if score ghost_guys_1 Wave matches 6 run summon minecraft:area_effect_cloud 687 102 -16 {Tags:["target"],Duration:1}
