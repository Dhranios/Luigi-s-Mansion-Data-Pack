...
execute if entity @s[tag=dead] unless score #orville OneGoHealth matches 0.. run scoreboard players operation #henry_and_orville OneGoHealth = @s Health
...
execute if entity @s[tag=disappear] unless score #orville OneGoHealth matches 0.. run scoreboard players operation #henry_and_orville OneGoHealth = @s Health
