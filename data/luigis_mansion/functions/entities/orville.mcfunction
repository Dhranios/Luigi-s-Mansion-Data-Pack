...
execute if entity @s[tag=dead] unless score #orville OneGoHealth matches 0.. run scoreboard players operation #orville OneGoHealth = @s Health
execute if entity @s[tag=dead] run scoreboard players set #orville LastHealth 0
execute if entity @s[tag=dead] run advancement grant @a only luigis_mansion:portrait_ghosts/orville
execute if entity @s[tag=disappear] unless score #orville OneGoHealth matches 0.. run scoreboard players operation #orville OneGoHealth = @s Health
...
execute if entity @s[tag=!fleeing,tag=!hurt,scores={StunTime=0},tag=!dialog] run function luigis_mansion:entities/orville/fly
