...
execute if entity @s[scores={Time=41}] run playsound luigis_mansion:entity.purple_puncher.attack hostile @a ~ ~ ~ 1
execute if entity @s[scores={Time=41..60}] if score #mirrored Selected matches 0 rotated ~342 0 run function luigis_mansion:entities/purple_puncher/punch/normal
execute if entity @s[scores={Time=41..60}] if score #mirrored Selected matches 1 rotated ~342 0 run function luigis_mansion:entities/purple_puncher/punch/hidden
