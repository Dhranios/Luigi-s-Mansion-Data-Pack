...
execute if entity @s[scores={AnimationProg=1}] run playsound luigis_mansion:entity.purple_puncher.complain hostile @a ~ ~ ~ 1
...
tag @s[scores={AnimationProg=60}] remove complain
