...
execute if entity @s[scores={ActionTime=1}] run playsound luigis_mansion:entity.purple_puncher.spawn hostile @a ~ ~ ~ 1
...
function luigis_mansion:animations/purple_puncher/appear
