...
teleport @s[scores={PathStep=1},tag=!burning] ~ ~ ~ facing 668 102 16
scoreboard players set @s[x=668.5,y=102,z=16.5,distance=..0.7,scores={PathStep=1},tag=!burning] PathStep 2
teleport @s[scores={PathStep=2},tag=!burning] ~ ~ ~ facing 668 102 0
scoreboard players set @s[x=668.5,y=102,z=0.5,distance=..0.7,scores={PathStep=2},tag=!burning] PathStep 1
...
teleport @s[scores={PathStep=1},tag=burning] ~ ~ ~ facing 668 102 21
scoreboard players set @s[x=668.5,y=102,z=21.5,distance=..0.7,scores={PathStep=1},tag=burning] PathStep 2
teleport @s[scores={PathStep=2},tag=burning] ~ ~ ~ facing 702 102 21
scoreboard players set @s[x=702.5,y=102,z=21.5,distance=..0.7,scores={PathStep=2},tag=burning] PathStep 3
teleport @s[scores={PathStep=3}] ~ ~ ~ facing 702 102 33
scoreboard players set @s[x=702.5,y=102,z=33.5,distance=..0.7,scores={PathStep=3}] PathStep 4
teleport @s[scores={PathStep=4}] ~ ~ ~ facing 702 102 -30
scoreboard players set @s[x=702.5,y=102,z=-29.5,distance=..0.7,scores={PathStep=4}] PathStep 5
teleport @s[scores={PathStep=5}] ~ ~ ~ facing 708 102 -30
scoreboard players set @s[x=708.5,y=102,z=-29.5,distance=..0.7,scores={PathStep=5}] PathStep 6
teleport @s[scores={PathStep=6}] ~ ~ ~ facing 710 102 -38
scoreboard players set @s[x=710.5,y=102,z=-37.5,distance=..0.7,scores={PathStep=6}] PathStep 7
teleport @s[scores={PathStep=7}] ~ ~ ~ facing 713 102 -36
scoreboard players set @s[x=713.5,y=102,z=-35.5,distance=..0.7,scores={PathStep=7}] PathStep 8
...
teleport @s[tag=disappear] 702 102 -32
