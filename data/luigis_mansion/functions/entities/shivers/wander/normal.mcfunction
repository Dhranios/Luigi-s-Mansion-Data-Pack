...
teleport @s[scores={PathStep=1}] ~ ~ ~ facing 668 102 -1
scoreboard players set @s[x=668.5,y=102,z=-0.5,distance=..0.7,scores={PathStep=1}] PathStep 2
teleport @s[scores={PathStep=2}] ~ ~ ~ facing 668 102 15
scoreboard players set @s[x=668.5,y=102,z=15.5,distance=..0.7,scores={PathStep=2}] PathStep 1
...
teleport @s[scores={PathStep=44}] ~ ~ ~ facing 668 102 -6
scoreboard players set @s[x=668.5,y=102,z=-5.5,distance=..0.7,scores={PathStep=44}] PathStep 45
teleport @s[scores={PathStep=45}] ~ ~ ~ facing 702 102 -6
scoreboard players set @s[x=702.5,y=102,z=-5.5,distance=..0.7,scores={PathStep=45}] PathStep 46
teleport @s[scores={PathStep=46}] ~ ~ ~ facing 702 102 -18
scoreboard players set @s[x=702.5,y=102,z=-17.5,distance=..0.7,scores={PathStep=46}] PathStep 47
teleport @s[scores={PathStep=47}] ~ ~ ~ facing 702 102 45
scoreboard players set @s[x=702.5,y=102,z=45.5,distance=..0.7,scores={PathStep=47}] PathStep 48
teleport @s[scores={PathStep=48}] ~ ~ ~ facing 708 102 45
scoreboard players set @s[x=708.5,y=102,z=45.5,distance=..0.7,scores={PathStep=48}] PathStep 49
teleport @s[scores={PathStep=49}] ~ ~ ~ facing 710 102 53
scoreboard players set @s[x=710.5,y=102,z=53.5,distance=..0.7,scores={PathStep=49}] PathStep 50
teleport @s[scores={PathStep=50}] ~ ~ ~ facing 713 102 51
execute if entity @s[scores={PathStep=51..}] run scoreboard players add @s PathStep 1
scoreboard players set @s[x=713.5,y=102,z=51.5,distance=..0.7,scores={PathStep=50}] PathStep 51
...
execute at @s[scores={PathStep=71..91}] facing 713 102 50 run function luigis_mansion:entities/shivers/move_forward
...
teleport @s[tag=disappear,scores={PathStep=92..}] 702 102 47
