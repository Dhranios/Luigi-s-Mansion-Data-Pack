...
execute positioned ^ ^ ^0.5 as @e[tag=ghost,tag=hurt,tag=being_vacuumed] facing entity @s feet run function luigis_mansion:items/poltergust_3000/vacuuming_ghost_break
