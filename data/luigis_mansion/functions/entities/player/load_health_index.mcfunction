...
execute unless score #temp Time matches 1 if data storage luigis_mansion:data current_state.current_data.dead_players[-1] run function luigis_mansion:entities/player/load_health_index