...
execute store result score #temp Time run clear @s minecraft:diamond_pickaxe{luigis_mansion:{id:"luigis_mansion:flashlight"}} 0
execute if score #temp Time matches 0 run give @s[advancements={luigis_mansion:mansion/mansion=true}] minecraft:diamond_pickaxe{AttributeModifiers:[],HideFlags:63,Unbreakable:1b,Damage:5,CustomModelData:0,display:{Name:'{"italic":false,"color":"white","translate":"luigis_mansion:item.flashlight"}'},luigis_mansion:{id:"luigis_mansion:flashlight"}}
execute store result score #temp Time run clear @s minecraft:diamond_pickaxe{luigis_mansion:{id:"luigis_mansion:poltergust_3000"}} 0
execute if score #temp Time matches 0 run scoreboard players reset @s[advancements={luigis_mansion:mansion/mansion=true}] Element
...
execute if score #temp Time matches 0 unless entity @s[scores={GBHMap=0..}] run give @s[advancements={luigis_mansion:mansion/mansion=true}] minecraft:carrot_on_a_stick{HideFlags:63,Unbreakable:1b,Damage:1,CustomModelData:0,display:{Name:'{"italic":false,"color":"white","translate":"luigis_mansion:item.gameboy_horror"}'},luigis_mansion:{id:"luigis_mansion:gameboy_horror"}}
