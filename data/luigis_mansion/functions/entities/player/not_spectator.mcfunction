...
execute as @e[distance=..7,tag=ghost_marker,tag=can_spawn,tag=!ceiling_ghost] positioned ^ ^ ^4 unless entity @s[distance=..4] at @s if block ~ ~ ~ #luigis_mansion:ghosts_ignore run tag @s[tag=!only_forced_spawn] add spawn
execute positioned ~ ~5 ~ as @e[distance=..7,tag=ghost_marker,tag=can_spawn,tag=ceiling_ghost] positioned ~ ~-5 ~ positioned ^ ^ ^4 unless entity @s[distance=..4] at @s if block ~ ~ ~ #luigis_mansion:ghosts_ignore run tag @s[tag=!only_forced_spawn] add spawn
