...
execute if score #temp Time matches 1.. store result storage luigis_mansion:data current_state.current_data.money.gold_coin int 1 run scoreboard players remove #temp Time 1
