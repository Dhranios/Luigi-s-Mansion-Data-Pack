...
execute unless score #temp Time matches 1 run data modify storage luigis_mansion:data current_state.current_data.new_dead_players append from storage luigis_mansion:data current_state.current_data.dead_players[-1]
...
execute unless score #temp Time matches 1 if data storage luigis_mansion:data current_state.current_data.dead_players[-1] run function luigis_mansion:entities/player/remove_dead_entry_index