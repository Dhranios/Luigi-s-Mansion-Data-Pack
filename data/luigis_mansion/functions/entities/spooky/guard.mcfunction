...
execute if entity @s[scores={Dialog=21}] run playsound luigis_mansion:entity.spooky.breathe hostile @a ~ ~ ~ 1
execute if entity @s[scores={Dialog=31}] run playsound luigis_mansion:entity.spooky.breathe hostile @a ~ ~ ~ 1
...
execute at @s[scores={Dialog=163}] unless entity @e[tag=spooky_bone,distance=..1] run function luigis_mansion:entities/ghost/move_forward
