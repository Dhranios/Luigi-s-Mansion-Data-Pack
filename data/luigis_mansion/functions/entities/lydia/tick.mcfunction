...
execute if entity @s[tag=vanish] store result storage luigis_mansion:data current_state.current_data.portrait_ghosts.lydia.health int 1 run scoreboard players get @s Health
...
execute if entity @s[tag=complain,tag=!fleeing,tag=!hurt,scores={StunTime=0}] run function luigis_mansion:animations/lydia/complain
execute if entity @s[tag=move] run function luigis_mansion:animations/lydia/move
execute if entity @s[tag=!hurt,tag=!fleeing,tag=!complain,tag=!move,tag=!vanish,scores={StunTime=0}] run function luigis_mansion:animations/lydia/idle
execute if entity @s[tag=fleeing] run function luigis_mansion:animations/lydia/flee
execute if entity @s[tag=!fleeing,tag=hurt] run function luigis_mansion:entities/lydia/drop_brush
execute if entity @s[tag=!fleeing,tag=hurt] run function luigis_mansion:animations/lydia/hurt
