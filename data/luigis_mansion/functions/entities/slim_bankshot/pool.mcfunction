...
execute if entity @s[scores={Dialog=2}] run playsound luigis_mansion:entity.slim_bankshot.scream hostile @a ~ ~ ~ 1
execute if entity @s[scores={Dialog=11}] run function #luigis_mansion:entities/slim_bankshot/pool_path
execute if entity @s[scores={Dialog=12}] run playsound luigis_mansion:entity.slim_bankshot.scream hostile @a ~ ~ ~ 1
execute if entity @s[scores={Dialog=21}] run function #luigis_mansion:entities/slim_bankshot/pool_path
execute if entity @s[scores={Dialog=22}] run playsound luigis_mansion:entity.slim_bankshot.complain hostile @a ~ ~ ~ 1
scoreboard players set @s[scores={Dialog=30}] VulnerableTime 80
scoreboard players set @s[scores={Dialog=100}] Dialog 21
execute if entity @s[scores={Dialog=30,Sound=0}] run playsound luigis_mansion:entity.slim_bankshot.complain hostile @a ~ ~ ~ 1
