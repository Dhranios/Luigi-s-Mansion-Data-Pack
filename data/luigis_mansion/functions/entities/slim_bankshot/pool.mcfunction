...
execute if entity @s[scores={Time=1}] at @a[gamemode=!spectator,scores={Room=37}] positioned ^ ^ ^8 run effect give @s[distance=..8] minecraft:invisibility 1 0 true
execute if entity @s[scores={Time=11}] at @a[gamemode=!spectator,scores={Room=37}] positioned ^ ^ ^8 run effect give @s[distance=..8] minecraft:invisibility 1 0 true
execute if entity @s[scores={Time=21}] at @a[gamemode=!spectator,scores={Room=37}] positioned ^ ^ ^8 run effect give @s[distance=..8] minecraft:invisibility 1 0 true
