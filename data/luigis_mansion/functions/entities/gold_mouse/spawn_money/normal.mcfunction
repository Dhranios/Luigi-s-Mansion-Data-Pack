execute if entity @s[scores={Room=7}] run function luigis_mansion:entities/gold_mouse/spawn_money/loot/green_emerald
...
execute if entity @s[scores={Room=10}] run function luigis_mansion:entities/gold_mouse/spawn_money/loot/gold_bar
...
execute if entity @s[scores={Room=16}] run function luigis_mansion:entities/gold_mouse/spawn_money/loot/blue_sapphire
...
execute if entity @s[scores={Room=22}] run function luigis_mansion:entities/gold_mouse/spawn_money/loot/gold_bar
...
execute if entity @s[scores={Room=23}] run function luigis_mansion:entities/gold_mouse/spawn_money/loot/green_emerald
...
execute if entity @s[scores={Room=30},tag=!cheese] run function luigis_mansion:entities/gold_mouse/spawn_money/loot/red_ruby
...
execute if entity @s[scores={Room=31}] run function luigis_mansion:entities/gold_mouse/spawn_money/loot/blue_sapphire
...
execute if entity @s[scores={Room=40}] run function luigis_mansion:entities/gold_mouse/spawn_money/loot/bills
...
execute if entity @s[scores={Room=53}] run function luigis_mansion:entities/gold_mouse/spawn_money/loot/bills
