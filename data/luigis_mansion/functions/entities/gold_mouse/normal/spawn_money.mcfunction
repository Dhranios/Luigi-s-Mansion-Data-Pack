...
execute if entity @s[scores={Room=10}] run function luigis_mansion:entities/gold_mouse/spawn_money/gold_bar
...
execute if entity @s[scores={Room=22}] run function luigis_mansion:entities/gold_mouse/spawn_money/gold_bar
