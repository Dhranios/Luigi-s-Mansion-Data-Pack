...
execute if entity @s[scores={Time=1}] run playsound luigis_mansion:entity.mirror_ghost.attack hostile @a ~ ~ ~ 1
...
execute if entity @s[scores={Time=1..20}] if score #mirrored Selected matches 0 run function luigis_mansion:entities/mirror_ghost/grab/normal
execute if entity @s[scores={Time=1..20}] if score #mirrored Selected matches 1 run function luigis_mansion:entities/mirror_ghost/grab/hidden
