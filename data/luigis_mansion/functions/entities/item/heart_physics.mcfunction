...
execute if entity @s[tag=bounce,scores={Time=0}] if block ~ ~-0.9 ~ #luigis_mansion:items_ignore if block ~ ~0.4 ~ #luigis_mansion:items_ignore run function luigis_mansion:entities/item/bounce_top
...
execute if entity @s[tag=bounce,scores={Time=2..}] if block ~ ~0.4 ~ #luigis_mansion:items_ignore if block ~ ~0.9 ~ #luigis_mansion:items_ignore run function luigis_mansion:entities/item/bounce_top

execute store result score @s HomeY run data get entity @s Pos[1] 100
execute unless entity @s[scores={Time=1..}] at @s positioned ~ ~1.4 ~ if block ^ ^ ^0.4 #luigis_mansion:ghosts_ignore unless block ^ ^ ^0.4 #minecraft:slabs at @s run teleport @s ^ ^ ^0.2
execute if entity @s[scores={Time=1}] at @s positioned ~ ~1.4 ~ if block ^ ^ ^0.2 #luigis_mansion:ghosts_ignore unless block ^ ^ ^0.2 #minecraft:slabs at @s run teleport @s ^ ^ ^0.1
execute if entity @s[scores={Time=2..}] at @s positioned ~ ~1.4 ~ if block ^ ^ ^0.1 #luigis_mansion:ghosts_ignore unless block ^ ^ ^0.1 #minecraft:slabs at @s run teleport @s ^ ^ ^0.05
