...
execute if entity @s[scores={SpawnTime=1..20}] run function luigis_mansion:animations/elemental_ghost/spawn
...
data merge entity @s[tag=fire_elemental_ghost,tag=hurt,tag=!was_hurt] {ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:90}}]}
data merge entity @s[tag=water_elemental_ghost,tag=hurt,tag=!was_hurt] {ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:92}}]}
data merge entity @s[tag=ice_elemental_ghost,tag=hurt,tag=!was_hurt] {ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:94}}]}
...
execute if entity @s[tag=!dead,tag=!hurt,scores={SpawnTime=21..}] positioned ~ ~0.8 ~ if entity @a[gamemode=!spectator,distance=..1] run function luigis_mansion:entities/elemental_ghost/attack
execute if entity @s[tag=!dead,tag=!hurt,scores={SpawnTime=21..}] positioned ~ ~-0.2 ~ if entity @a[gamemode=!spectator,distance=..1] run function luigis_mansion:entities/elemental_ghost/attack