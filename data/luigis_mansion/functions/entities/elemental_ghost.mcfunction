...
execute at @s[scores={SpawnTime=21..60}] if block ^ ^ ^0.3 #luigis_mansion:ghosts_ignore run teleport @s ^ ^ ^0.01
...
execute at @s[scores={SpawnTime=80..},tag=!bounce] if block ~ ~-0.1 ~ #luigis_mansion:ghosts_ignore run teleport @s ~ ~-0.1 ~
execute at @s[scores={SpawnTime=80..},tag=bounce] if block ~ ~0.4 ~ #luigis_mansion:ghosts_ignore run teleport @s ~ ~0.1 ~
execute at @s[scores={SpawnTime=80..}] if block ~ ~-0.7 ~ #luigis_mansion:ghosts_ignore run tag @s remove bounce
execute at @s[scores={SpawnTime=80..}] unless block ~ ~-0.1 ~ #luigis_mansion:ghosts_ignore run tag @s add bounce
