...
execute if entity @s[scores={Dialog=1000..}] if entity @a[scores={Choice=1..}] as @a[scores={Choice=0}] run trigger Choice set 0
execute if entity @s[scores={Dialog=1000..}] run scoreboard players set @a Choice 0
...
execute if entity @s[scores={Dialog=2216}] positioned 657 101 -9 run function luigis_mansion:spawn_entities/vacuumable/haunted_object/haunted_music_sheet
