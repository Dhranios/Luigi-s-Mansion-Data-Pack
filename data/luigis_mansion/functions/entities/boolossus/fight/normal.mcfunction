execute if entity @s[tag=!split] run function luigis_mansion:entities/boolossus/battle/normal/merged
execute if entity @s[tag=split] run function luigis_mansion:entities/boolossus/battle/normal/split
