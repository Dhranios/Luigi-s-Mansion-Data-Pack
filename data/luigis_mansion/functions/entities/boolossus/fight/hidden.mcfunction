execute if entity @s[tag=!split] run function luigis_mansion:entities/boolossus/battle/hidden/merged
execute if entity @s[tag=split] run function luigis_mansion:entities/boolossus/battle/hidden/split
