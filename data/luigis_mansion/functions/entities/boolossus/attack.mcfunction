...
execute if entity @s[scores={ActionTime=1..19}] run function luigis_mansion:animations/boo/laugh
data merge entity @s[scores={ActionTime=20}] {Pose:{RightArm:[-90.0f,90.0f,0.0f],LeftArm:[-90.0f,-90.0f,0.0f],Head:[0.0f,0.0f,0.0f]}}
