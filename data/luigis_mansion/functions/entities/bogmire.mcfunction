execute if entity @s[tag=dying,scores={HurtTime=1}] run playsound luigis_mansion:entity.bogmire.vacumed hostile @a ~ ~ ~ 1
...
execute if entity @s[tag=dead] run scoreboard players set #bogmire LastHealth 0
