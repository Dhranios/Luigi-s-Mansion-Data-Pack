...
execute if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore run teleport @s[tag=chauncey,tag=!spit,tag=land] ^ ^0.05 ^0.05
execute positioned as @s[tag=chauncey,tag=!spit] unless block ~ ~-0.1 ~ #luigis_mansion:ghosts_ignore run tag @s add land
execute positioned as @s[tag=chauncey,tag=!spit] if block ~ ~-0.1 ~ #luigis_mansion:ghosts_ignore if block ~ ~-1.1 ~ #luigis_mansion:ghosts_ignore if block ~ ~-2.1 ~ #luigis_mansion:ghosts_ignore if block ~ ~-3.1 ~ #luigis_mansion:ghosts_ignore run tag @s remove land
...
execute positioned as @s[tag=!land] unless block ~ ~ ~ #luigis_mansion:ghosts_ignore if block ~ ~0.1 ~ #luigis_mansion:ghosts_ignore run teleport @s ~ ~0.1 ~
...
execute if score #temp Move matches 1.. unless block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore rotated ~ 0 if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore run function luigis_mansion:entities/ball/move_forward
