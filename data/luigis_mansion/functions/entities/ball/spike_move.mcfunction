execute if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore run teleport @s[tag=!spit,tag=!land] ^ ^-0.05 ^0.05
execute if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore run teleport @s[tag=!spit,tag=land] ^ ^ ^0.05
execute positioned as @s[tag=!spit] unless block ~ ~-0.1 ~ #luigis_mansion:ghosts_ignore run tag @s add land
execute positioned as @s[tag=!spit] if block ~ ~-0.1 ~ #luigis_mansion:ghosts_ignore run tag @s remove land
...
execute positioned as @s unless block ~ ~ ~ #luigis_mansion:ghosts_ignore if block ~ ~0.1 ~ #luigis_mansion:ghosts_ignore run teleport @s ~ ~0.1 ~
