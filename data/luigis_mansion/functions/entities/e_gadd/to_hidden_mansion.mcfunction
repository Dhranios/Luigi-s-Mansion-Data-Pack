...
execute if score #mansion_type Selected matches -1 unless data storage luigis_mansion:data current_state.current_data.rooms.arlor{cleared:1b} run scoreboard players set #can_clear_hidden Selected 1
