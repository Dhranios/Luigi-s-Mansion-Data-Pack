...
execute if entity @s[tag=gold_ghost,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/gold_ghost
execute if entity @s[tag=gold_dummy_ghost,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/gold_dummy_ghost
execute if entity @s[tag=temper_terror,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/temper_terror
execute if entity @s[tag=speedy_spirit,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/speedy_spirit
execute if entity @s[tag=purple_puncher,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/purple_puncher
execute if entity @s[tag=flash,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/flash
execute if entity @s[tag=blue_twirler,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/blue_twirler
execute if entity @s[tag=blue_blaze,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/blue_blaze
execute if entity @s[tag=grabbing_ghost,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/grabbing_ghost
execute if entity @s[tag=red_grabbing_ghost,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/red_grabbing_ghost
execute if entity @s[tag=mirror_ghost,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/mirror_ghost
execute if entity @s[tag=cinema_ghost,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/cinema_ghost
execute if entity @s[tag=garbage_can_ghost,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/garbage_can_ghost
execute if entity @s[tag=ghost_guy,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/ghost_guy
execute if entity @s[tag=mr_bones,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/mr_bones
execute if entity @s[tag=bowling_ghost,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/bowling_ghost
execute if entity @s[tag=ceiling_surprise,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/ceiling_surprise
execute if entity @s[tag=purple_bomber,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/purple_bomber
execute if entity @s[tag=waiter,tag=!disappear,tag=!element_hurt] run function luigis_mansion:entities/waiter
