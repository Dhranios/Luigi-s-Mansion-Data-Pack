...
execute if entity @s[scores={Time=1}] run replaceitem entity @s weapon.mainhand minecraft:bone

execute if entity @s[scores={Time=40}] run playsound luigis_mansion:entity.mr_bones.attack hostile @a ~ ~ ~ 1
execute if entity @s[scores={Time=40}] run replaceitem entity @s weapon.mainhand minecraft:air
execute if entity @s[scores={Time=40}] run summon minecraft:armor_stand ~ ~0.4 ~ {NoGravity:1b,Tags:["bone"],Pose:{Head:[0.0f,0.0f,90.0f]},ArmorItems:[{},{},{},{id:"minecraft:bone",Count:1b}],Invisible:1b,DisabledSlots:2039583,Small:1b}
