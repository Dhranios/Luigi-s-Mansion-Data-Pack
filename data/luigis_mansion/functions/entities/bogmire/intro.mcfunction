...
execute if entity @s[scores={Time=2}] run scoreboard players set @a[tag=same_room] MusicType 16
execute if entity @s[scores={Time=2}] run scoreboard players set @a[tag=same_room] Music 0
