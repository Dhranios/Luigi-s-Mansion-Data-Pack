...
execute if entity @s[tag=intro_done,scores={Time=181}] run function luigis_mansion:entities/bogmire/vacuum_spawn
execute if entity @s[tag=intro_done,scores={Time=201}] run function luigis_mansion:entities/bogmire/vacuum_spawn
execute if entity @s[tag=intro_done,scores={Time=221}] run function luigis_mansion:entities/bogmire/vacuum_spawn
execute if entity @s[tag=intro_done,scores={Time=241}] run function luigis_mansion:entities/bogmire/vacuum_spawn
execute if entity @s[tag=intro_done,scores={Time=261}] run function luigis_mansion:entities/bogmire/vacuum_spawn
