...
execute unless entity @e[tag=bogmire,tag=!intro,tag=!dead,limit=1] positioned 720.0 41 -19960.5 run function luigis_mansion:spawn_entities/portrait_ghost/bogmire/fight