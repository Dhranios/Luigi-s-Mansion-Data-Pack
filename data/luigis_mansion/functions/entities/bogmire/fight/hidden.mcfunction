...
execute if entity @s[tag=intro_done,scores={Time=70}] run teleport @s ~ ~-4 ~
execute if entity @s[tag=intro_done,scores={Time=110}] run function luigis_mansion:entities/bogmire/warp
...
execute if entity @s[tag=intro_done,scores={Time=280}] run scoreboard players set @s Time 109

execute if entity @e[distance=..0.7,tag=shadow] run scoreboard players set @s VulnerableTime 280
scoreboard players set @s[scores={VulnerableTime=1}] Time 69