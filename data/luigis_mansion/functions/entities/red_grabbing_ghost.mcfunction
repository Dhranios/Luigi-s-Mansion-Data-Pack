execute if entity @s[tag=dying,tag=normal_death,scores={HurtTime=1}] run playsound luigis_mansion:entity.red_grabbing_ghost.vacuumed hostile @a ~ ~ ~ 1
execute if entity @s[tag=dying,tag=element_death,scores={HurtTime=1}] run playsound luigis_mansion:entity.red_grabbing_ghost.element_death hostile @a ~ ~ ~ 1
...
execute if entity @s[scores={HurtTime=1},tag=hurt] run playsound luigis_mansion:entity.red_grabbing_ghost.hurt hostile @a ~ ~ ~ 1
...
execute if entity @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=laugh,scores={StunTime=0}] run function luigis_mansion:entities/red_grabbing_ghost/laugh
execute if entity @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=complain,scores={StunTime=0}] run function luigis_mansion:entities/red_grabbing_ghost/complain
