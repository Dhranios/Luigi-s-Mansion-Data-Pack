execute if block ~ ~-4 ~ minecraft:air if block ~ ~-3 ~ minecraft:air if block ~ ~-2 ~ minecraft:air if block ~ ~-1 ~ minecraft:air run tag @s add at_height
execute unless block ~ ~2 ~ minecraft:air run tag @s add at_height
teleport @s[tag=!at_height] ~ ~0.3 ~
