execute if entity @s[tag=dying,tag=normal_death,scores={HurtTime=1}] run playsound luigis_mansion:entity.temper_terror.vacumed hostile @a ~ ~ ~ 1
...
execute if entity @s[tag=burning_heart] run particle minecraft:flame ~ ~1 ~ 0.2 0.2 0.2 0 1 force
...
execute if entity @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=laugh,scores={StunTime=0}] run function luigis_mansion:entities/temper_terror/laugh
execute if entity @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=complain,scores={StunTime=0}] run function luigis_mansion:entities/temper_terror/complain
