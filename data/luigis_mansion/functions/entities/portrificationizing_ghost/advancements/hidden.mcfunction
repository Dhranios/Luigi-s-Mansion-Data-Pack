...
execute if entity @s[tag=chauncey] if score #small_hallway Ticking matches 1 run function luigis_mansion:room/hidden/small_hallway/turn_on_lights
...
execute if entity @s[tag=bogmire] if score #main_hallway Ticking matches 1 run function luigis_mansion:room/hidden/main_hallway/turn_on_lights
execute if entity @s[tag=bogmire] if score #basement_stairs Ticking matches 1 run function luigis_mansion:room/hidden/basement_stairs/turn_on_lights
...
execute if entity @s[tag=boolossus] if score #hallway Ticking matches 1 run function luigis_mansion:room/hidden/hallway/turn_on_lights
execute if entity @s[tag=boolossus] if score #main_stairs Ticking matches 1 run function luigis_mansion:room/hidden/main_stairs/turn_on_lights
