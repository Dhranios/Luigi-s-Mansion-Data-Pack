...
execute if score #temp Time matches 0 run advancement grant @a until luigis_mansion:portrait_ghosts/mr_luggs/bronze
execute if score #temp Time matches 1 run advancement grant @a until luigis_mansion:portrait_ghosts/mr_luggs/silver
execute if score #temp Time matches 2 run advancement grant @a until luigis_mansion:portrait_ghosts/mr_luggs/gold
