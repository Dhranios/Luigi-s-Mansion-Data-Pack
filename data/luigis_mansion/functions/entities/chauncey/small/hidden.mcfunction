...
execute if entity @s[scores={Dialog=170},tag=complain] run tag @e[scores={Room=9},tag=haunted_teddy_bear] remove enabled
tag @s[scores={Dialog=170}] remove rambling
execute if entity @s[scores={Dialog=170}] if entity @e[tag=haunted_teddy_bear,scores={Room=9,WaitTime=60..}] run tag @s add rambling
...
execute if entity @s[scores={Dialog=171}] run tag @e[scores={Room=9},tag=haunted_teddy_bear] remove enabled
...
execute if entity @s[scores={Dialog=290}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.chauncey","color":"green"},{"translate":"luigis_mansion:dialog.chauncey.1"}]}
execute if entity @s[scores={Dialog=290}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.chauncey","color":"green"},{"translate":"luigis_mansion:dialog.chauncey.1.more"}]}
tag @s[scores={Dialog=338}] remove rambling
execute if entity @s[scores={Dialog=338}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.chauncey","color":"green"},{"translate":"luigis_mansion:dialog.chauncey.2"}]}
execute if entity @s[scores={Dialog=338}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.chauncey","color":"green"},{"translate":"luigis_mansion:dialog.chauncey.2.more"}]}
execute if entity @s[scores={Dialog=426}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.chauncey","color":"green"},{"translate":"luigis_mansion:dialog.chauncey.3"}]}
