...
execute if entity @s[scores={ActionTime=1}] run data merge entity @e[tag=this_chauncey_body,limit=1] {Pose:{RightArm:[0.0f,0.0f,90.0f],LeftArm:[0.0f,0.0f,-90.0f],Head:[0.0f,0.0f,0.0f]}}
data modify entity @s[scores={ActionTime=1}] ArmorItems[3].tag merge value {Unbreakable:1b,Damage:1,CustomModelData:113}
