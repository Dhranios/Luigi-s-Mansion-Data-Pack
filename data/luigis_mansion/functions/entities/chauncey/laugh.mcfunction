...
execute if entity @s[scores={ActionTime=1}] run playsound luigis_mansion:entity.chauncey.laugh hostile @a ~ ~ ~ 1
function luigis_mansion:animations/chauncey/laugh
