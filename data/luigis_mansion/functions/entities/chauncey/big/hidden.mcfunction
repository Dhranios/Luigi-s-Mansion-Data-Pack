...
execute if entity @a[advancements={luigis_mansion:mansion/nursery=true}] as @a[distance=..80] run function luigis_mansion:entities/chauncey/return
execute if entity @a[advancements={luigis_mansion:mansion/nursery=false}] as @a[distance=80..] run function luigis_mansion:entities/chauncey/to_arena
...
tag @s[scores={Wave=1,Health=..5000}] add left
...
execute if entity @s[scores={Wave=280}] positioned 713 45 -19958 run function luigis_mansion:spawn_entities/ball/chauncey/big
execute if entity @s[scores={Wave=300}] positioned 726 45 -19958 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
execute if entity @s[scores={Wave=340}] positioned 713 45 -19958 run function luigis_mansion:spawn_entities/ball/chauncey/big
execute if entity @s[scores={Wave=360}] positioned 726 45 -19958 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
teleport @s[scores={Wave=1583,Dialog=1..5}] ^ ^0.4 ^0.4
teleport @s[scores={Wave=1583,Dialog=6..10}] ^ ^-0.4 ^0.4
execute at @s[scores={Wave=1583,Dialog=10}] run effect give @a[distance=..1,gamemode=!spectator] minecraft:instant_damage 1 0 true
execute at @s[scores={Wave=1583,Dialog=10}] run scoreboard players set @a[distance=..1,gamemode=!spectator] ForcedDamage 4
...
scoreboard players set @s[scores={Wave=1583,Dialog=10}] Dialog 0
