...
teleport @s[scores={Wave=583,Dialog=1..5}] ^ ^0.4 ^0.4
teleport @s[scores={Wave=583,Dialog=6..10}] ^ ^-0.4 ^0.4
execute at @s[scores={Wave=583,Dialog=10}] run effect give @a[distance=..1,gamemode=!spectator] minecraft:instant_damage 1 0 true
execute at @s[scores={Wave=583,Dialog=10}] run scoreboard players set @a[distance=..1,gamemode=!spectator] ForcedDamage 4
...
scoreboard players set @s[scores={Wave=583,Dialog=10}] Dialog 0
...
scoreboard players set @s[scores={Wave=634}] Wave 0
