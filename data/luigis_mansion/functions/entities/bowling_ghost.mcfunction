...
execute if entity @s[scores={Sound=0},tag=!fleeing,tag=!attack,tag=!laugh,tag=!complain,tag=grabbed_ball,tag=!disappear] run playsound luigis_mansion:entity.bowling_ghost.ambient hostile @a ~ ~ ~ 1
...
execute if entity @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=!laugh,tag=!complain,tag=grabbed_ball,scores={StunTime=0,SpawnTime=20..},tag=!disappear] run function luigis_mansion:entities/bowling_ghost/line_of_sight
...
execute at @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=!vanish,scores={StunTime=0},tag=!disappear] facing entity @p[gamemode=!spectator] feet rotated ~ 0 run teleport @s ~ ~ ~ ~ ~
execute if entity @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=laugh,scores={StunTime=0},tag=!disappear] run function luigis_mansion:entities/bowling_ghost/laugh
execute if entity @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=complain,scores={StunTime=0},tag=!disappear] run function luigis_mansion:entities/bowling_ghost/complain
...
execute if entity @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=!vanish,tag=!laugh,tag=!complain,tag=!appear,tag=grabbed_ball,scores={StunTime=0},tag=!disappear] run function luigis_mansion:entities/bowling_ghost/idle
