...
execute if entity @s[tag=!fleeing,tag=!attack,tag=!collided,tag=!laugh,tag=!complain,tag=!grab_ball,scores={StunTime=0}] run function luigis_mansion:entities/bowling_ghost/line_of_sight
scoreboard players reset #temp Steps
execute if entity @s[tag=!fleeing,tag=!collided,tag=attack,scores={StunTime=0}] run function luigis_mansion:entities/bowling_ghost/attack
...
execute if entity @s[tag=!fleeing,tag=!collided,tag=grab_ball,scores={StunTime=0}] run function luigis_mansion:entities/bowling_ghost/grab_ball
execute if entity @s[tag=!fleeing,tag=!attack,tag=!collided,tag=laugh,scores={StunTime=0}] run function luigis_mansion:entities/bowling_ghost/laugh
execute if entity @s[tag=!fleeing,tag=!attack,tag=!collided,tag=complain,scores={StunTime=0}] run function luigis_mansion:entities/bowling_ghost/complain
