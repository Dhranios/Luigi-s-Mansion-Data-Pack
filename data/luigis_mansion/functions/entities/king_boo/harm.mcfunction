...
execute if score #extra_damage Selected matches 0 run scoreboard players remove @s Health 24
execute if score #extra_damage Selected matches 1 run scoreboard players remove @s Health 36
