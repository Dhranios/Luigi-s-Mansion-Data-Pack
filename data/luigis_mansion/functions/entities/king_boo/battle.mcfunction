...
execute at @s[tag=!fleeing,tag=!boo_hurt,scores={Wave=1..120}] run function luigis_mansion:entities/king_boo/move_forward
execute at @s[tag=!fleeing,tag=!boo_hurt,scores={Wave=121..}] run function luigis_mansion:entities/king_boo/move_back

scoreboard players set @s[tag=!boo_hurt,tag=!fleeing,tag=!dying] Time 0
...
execute if entity @s[scores={Wave=121..}] if entity @e[tag=bowser_body,distance=..2,limit=1] run scoreboard players reset @e[tag=bowser,limit=1] Time
...
execute if entity @s[scores={Wave=121..}] positioned ~ ~-4 ~ if entity @e[tag=bowser_body,distance=..2,limit=1] run scoreboard players reset @e[tag=bowser,limit=1] Time
