...
execute if entity @s[scores={ActionTime=1}] run playsound luigis_mansion:block.door.fake_open block @a ~ ~ ~ 1
execute if entity @s[scores={ActionTime=20}] run playsound luigis_mansion:entity.ghost.laugh block @a ~ ~ ~ 1
execute if entity @s[scores={ActionTime=20}] run playsound luigis_mansion:block.door.fake_closing block @a ~ ~ ~ 1
execute if entity @s[scores={ActionTime=35}] run playsound luigis_mansion:block.door.fake_close block @a ~ ~ ~ 1
