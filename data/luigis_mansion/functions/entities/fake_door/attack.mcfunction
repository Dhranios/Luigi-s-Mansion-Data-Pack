...
execute if entity @s[scores={Time=1}] run playsound luigis_mansion:block.door.fake_open block @a ~ ~ ~ 1
execute if entity @s[scores={Time=20}] run playsound luigis_mansion:entity.ghost.laugh block @a ~ ~ ~ 1
execute if entity @s[scores={Time=20}] run playsound luigis_mansion:block.door.fake_closing block @a ~ ~ ~ 1
execute if entity @s[scores={Time=35}] run playsound luigis_mansion:block.door.fake_close block @a ~ ~ ~ 1
...
execute if entity @s[scores={Time=3}] if entity @s[tag=north] run fill ~ ~ ~1 ~ ~1 ~1 minecraft:air
execute if entity @s[scores={Time=5}] if entity @s[tag=north] run fill ~ ~ ~1 ~ ~1 ~1 minecraft:air
execute if entity @s[scores={Time=7}] if entity @s[tag=north] run fill ~1 ~ ~1 ~1 ~1 ~1 minecraft:air
execute if entity @s[scores={Time=20}] if entity @s[tag=north] run fill ~1 ~ ~1 ~1 ~1 ~1 minecraft:air
execute if entity @s[scores={Time=25}] if entity @s[tag=north] run fill ~1 ~ ~1 ~1 ~1 ~1 minecraft:air
execute if entity @s[scores={Time=30}] if entity @s[tag=north] run fill ~ ~ ~1 ~ ~1 ~1 minecraft:air
execute if entity @s[scores={Time=35}] if entity @s[tag=north] run fill ~ ~ ~1 ~ ~1 ~1 minecraft:air
execute if entity @s[scores={Time=3}] if entity @s[tag=south] run fill ~ ~ ~-1 ~ ~1 ~-1 minecraft:air
execute if entity @s[scores={Time=3}] if entity @s[tag=south] run fill ~ ~ ~-1 ~ ~1 ~-1 minecraft:air
execute if entity @s[scores={Time=5}] if entity @s[tag=south] run fill ~ ~ ~-1 ~ ~1 ~-1 minecraft:air
execute if entity @s[scores={Time=7}] if entity @s[tag=south] run fill ~1 ~ ~-1 ~1 ~1 ~-1 minecraft:air
execute if entity @s[scores={Time=20}] if entity @s[tag=south] run fill ~1 ~ ~-1 ~1 ~1 ~-1 minecraft:air
execute if entity @s[scores={Time=25}] if entity @s[tag=south] run fill ~1 ~ ~-1 ~1 ~1 ~-1 minecraft:air
execute if entity @s[scores={Time=30}] if entity @s[tag=south] run fill ~ ~ ~-1 ~ ~1 ~-1 minecraft:air
execute if entity @s[scores={Time=35}] if entity @s[tag=south] run fill ~ ~ ~-1 ~ ~1 ~-1 minecraft:air
execute if entity @s[scores={Time=3}] if entity @s[tag=west] run fill ~1 ~ ~ ~1 ~1 ~ minecraft:air
execute if entity @s[scores={Time=5}] if entity @s[tag=west] run fill ~1 ~ ~ ~1 ~1 ~ minecraft:air
execute if entity @s[scores={Time=7}] if entity @s[tag=west] if score #mirrored Selected matches 0 run fill ~1 ~ ~-1 ~1 ~1 ~-1 minecraft:air
execute if entity @s[scores={Time=7}] if entity @s[tag=west] if score #mirrored Selected matches 1 run fill ~1 ~ ~1 ~1 ~1 ~1 minecraft:air
execute if entity @s[scores={Time=20}] if entity @s[tag=west] if score #mirrored Selected matches 0 run fill ~1 ~ ~-1 ~1 ~1 ~-1 minecraft:air
execute if entity @s[scores={Time=20}] if entity @s[tag=west] if score #mirrored Selected matches 1 run fill ~1 ~ ~1 ~1 ~1 ~1 minecraft:air
...
execute if entity @s[scores={Time=30}] if entity @s[tag=west] run fill ~1 ~ ~ ~1 ~1 ~ minecraft:air
...
execute if entity @s[scores={Time=3}] if entity @s[tag=normal,tag=north] run setblock ~ ~1 ~1 minecraft:dark_oak_door[facing=south,half=upper,hinge=left,open=true]
...
execute if entity @s[scores={Time=7}] if entity @s[tag=normal,tag=north] run setblock ~1 ~1 ~1 minecraft:dark_oak_door[facing=east,half=upper,hinge=left,open=true]
...
execute if entity @s[scores={Time=20}] if entity @s[tag=normal,tag=north] run setblock ~1 ~1 ~1 minecraft:dark_oak_door[facing=east,half=upper,hinge=left,open=false]
...
execute if entity @s[scores={Time=30}] if entity @s[tag=normal,tag=north] run setblock ~ ~1 ~1 minecraft:dark_oak_door[facing=south,half=upper,hinge=left,open=false]
...
execute if entity @s[scores={Time=3}] if entity @s[tag=normal,tag=south] run setblock ~ ~1 ~-1 minecraft:dark_oak_door[facing=north,half=upper,hinge=right,open=true]
...
execute if entity @s[scores={Time=7}] if entity @s[tag=normal,tag=south] run setblock ~1 ~1 ~-1 minecraft:dark_oak_door[facing=east,half=upper,hinge=right,open=true]
...
execute if entity @s[scores={Time=20}] if entity @s[tag=normal,tag=south] run setblock ~1 ~1 ~-1 minecraft:dark_oak_door[facing=east,half=upper,hinge=right,open=false]
...
execute if entity @s[scores={Time=30}] if entity @s[tag=normal,tag=south] run setblock ~ ~1 ~-1 minecraft:dark_oak_door[facing=north,half=upper,hinge=right,open=false]
...
execute if entity @s[scores={Time=3}] if entity @s[tag=normal,tag=west] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~ minecraft:dark_oak_door[facing=east,half=upper,hinge=left,open=true]
...
execute if entity @s[scores={Time=7}] if entity @s[tag=normal,tag=west] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~-1 minecraft:dark_oak_door[facing=north,half=upper,hinge=left,open=true]
...
execute if entity @s[scores={Time=20}] if entity @s[tag=normal,tag=west] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~-1 minecraft:dark_oak_door[facing=north,half=upper,hinge=left,open=false]
...
execute if entity @s[scores={Time=30}] if entity @s[tag=normal,tag=west] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~ minecraft:dark_oak_door[facing=east,half=upper,hinge=left,open=false]
...
execute if entity @s[scores={Time=3}] if entity @s[tag=normal,tag=west] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~ minecraft:dark_oak_door[facing=east,half=upper,hinge=right,open=true]
...
execute if entity @s[scores={Time=7}] if entity @s[tag=normal,tag=west] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~1 minecraft:dark_oak_door[facing=south,half=upper,hinge=right,open=true]
...
execute if entity @s[scores={Time=20}] if entity @s[tag=normal,tag=west] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~1 minecraft:dark_oak_door[facing=south,half=upper,hinge=right,open=false]
...
execute if entity @s[scores={Time=30}] if entity @s[tag=normal,tag=west] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~ minecraft:dark_oak_door[facing=east,half=upper,hinge=right,open=false]
...
execute if entity @s[scores={Time=3}] if entity @s[tag=attic,tag=north] run setblock ~ ~1 ~1 minecraft:oak_door[facing=south,half=upper,hinge=left,open=true]
...
execute if entity @s[scores={Time=7}] if entity @s[tag=attic,tag=north] run setblock ~1 ~1 ~1 minecraft:oak_door[facing=east,half=upper,hinge=left,open=true]
...
execute if entity @s[scores={Time=20}] if entity @s[tag=attic,tag=north] run setblock ~1 ~1 ~1 minecraft:oak_door[facing=east,half=upper,hinge=left,open=false]
...
execute if entity @s[scores={Time=30}] if entity @s[tag=attic,tag=north] run setblock ~ ~1 ~1 minecraft:oak_door[facing=south,half=upper,hinge=left,open=false]
...
execute if entity @s[scores={Time=3}] if entity @s[tag=attic,tag=south] run setblock ~ ~1 ~-1 minecraft:oak_door[facing=north,half=upper,hinge=right,open=true]
...
execute if entity @s[scores={Time=7}] if entity @s[tag=attic,tag=south] run setblock ~1 ~1 ~-1 minecraft:oak_door[facing=east,half=upper,hinge=right,open=true]
...
execute if entity @s[scores={Time=20}] if entity @s[tag=attic,tag=south] run setblock ~1 ~1 ~-1 minecraft:oak_door[facing=east,half=upper,hinge=right,open=false]
...
execute if entity @s[scores={Time=30}] if entity @s[tag=attic,tag=south] run setblock ~ ~1 ~-1 minecraft:oak_door[facing=north,half=upper,hinge=right,open=false]
...
execute if entity @s[scores={Time=3}] if entity @s[tag=attic,tag=west] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~ minecraft:oak_door[facing=east,half=upper,hinge=left,open=true]
...
execute if entity @s[scores={Time=7}] if entity @s[tag=attic,tag=west] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~-1 minecraft:oak_door[facing=north,half=upper,hinge=left,open=true]
...
execute if entity @s[scores={Time=20}] if entity @s[tag=attic,tag=west] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~-1 minecraft:oak_door[facing=north,half=upper,hinge=left,open=false]
...
execute if entity @s[scores={Time=30}] if entity @s[tag=attic,tag=west] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~ minecraft:oak_door[facing=east,half=upper,hinge=left,open=false]
...
execute if entity @s[scores={Time=3}] if entity @s[tag=attic,tag=west] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~ minecraft:oak_door[facing=east,half=upper,hinge=right,open=true]
...
execute if entity @s[scores={Time=7}] if entity @s[tag=attic,tag=west] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~1 minecraft:oak_door[facing=south,half=upper,hinge=right,open=true]
...
execute if entity @s[scores={Time=20}] if entity @s[tag=attic,tag=west] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~1 minecraft:oak_door[facing=south,half=upper,hinge=right,open=false]
...
execute if entity @s[scores={Time=30}] if entity @s[tag=attic,tag=west] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~ minecraft:oak_door[facing=east,half=upper,hinge=right,open=false]
...
execute if entity @s[scores={Time=3}] if entity @s[tag=laundry_room] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~ minecraft:warped_door[facing=east,half=upper,hinge=left,open=true]
...
execute if entity @s[scores={Time=7}] if entity @s[tag=laundry_room] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~-1 minecraft:warped_door[facing=north,half=upper,hinge=left,open=true]
...
execute if entity @s[scores={Time=20}] if entity @s[tag=laundry_room] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~-1 minecraft:warped_door[facing=north,half=upper,hinge=left,open=false]
...
execute if entity @s[scores={Time=30}] if entity @s[tag=laundry_room] if score #mirrored Selected matches 0 run setblock ~1 ~1 ~ minecraft:warped_door[facing=east,half=upper,hinge=left,open=false]
...
execute if entity @s[scores={Time=3}] if entity @s[tag=laundry_room] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~ minecraft:warped_door[facing=east,half=upper,hinge=right,open=true]
...
execute if entity @s[scores={Time=7}] if entity @s[tag=laundry_room] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~1 minecraft:warped_door[facing=south,half=upper,hinge=right,open=true]
...
execute if entity @s[scores={Time=20}] if entity @s[tag=laundry_room] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~1 minecraft:warped_door[facing=south,half=upper,hinge=right,open=false]
...
execute if entity @s[scores={Time=30}] if entity @s[tag=laundry_room] if score #mirrored Selected matches 1 run setblock ~1 ~1 ~ minecraft:warped_door[facing=east,half=upper,hinge=right,open=false]
