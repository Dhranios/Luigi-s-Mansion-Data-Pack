...
execute if entity @s[scores={AnimationProg=1}] if entity @s[tag=laundry_room] run setblock ~1 ~ ~ minecraft:warped_door[facing=east,half=lower,hinge=left,open=false]
execute if entity @s[scores={AnimationProg=1}] if entity @s[tag=laundry_room] run setblock ~1 ~1 ~ minecraft:warped_door[facing=east,half=upper,hinge=left,open=false]
execute if entity @s[scores={AnimationProg=3}] if entity @s[tag=laundry_room] run setblock ~1 ~ ~ minecraft:warped_door[facing=east,half=lower,hinge=left,open=true]
execute if entity @s[scores={AnimationProg=5}] if entity @s[tag=laundry_room] run setblock ~1 ~ ~-1 minecraft:warped_door[facing=north,half=lower,hinge=left,open=false]
execute if entity @s[scores={AnimationProg=5}] if entity @s[tag=laundry_room] run setblock ~1 ~1 ~-1 minecraft:warped_door[facing=north,half=upper,hinge=left,open=false]
execute if entity @s[scores={AnimationProg=7}] if entity @s[tag=laundry_room] run setblock ~1 ~ ~-1 minecraft:warped_door[facing=north,half=lower,hinge=left,open=true]
execute if entity @s[scores={AnimationProg=20}] if entity @s[tag=laundry_room] run setblock ~1 ~ ~-1 minecraft:warped_door[facing=north,half=lower,hinge=left,open=false]
execute if entity @s[scores={AnimationProg=25}] if entity @s[tag=laundry_room] run setblock ~1 ~ ~ minecraft:warped_door[facing=east,half=lower,hinge=left,open=true]
execute if entity @s[scores={AnimationProg=25}] if entity @s[tag=laundry_room] run setblock ~1 ~1 ~ minecraft:warped_door[facing=east,half=upper,hinge=left,open=true]
execute if entity @s[scores={AnimationProg=30}] if entity @s[tag=laundry_room] run setblock ~1 ~ ~ minecraft:warped_door[facing=east,half=lower,hinge=left,open=false]
execute if entity @s[scores={AnimationProg=35}] if entity @s[tag=laundry_room] run setblock ~ ~ ~ minecraft:warped_door[facing=west,half=lower,hinge=right,open=false]
execute if entity @s[scores={AnimationProg=35}] if entity @s[tag=laundry_room] run setblock ~ ~1 ~ minecraft:warped_door[facing=west,half=upper,hinge=right,open=false]
