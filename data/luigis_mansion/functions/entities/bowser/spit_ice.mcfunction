...
execute anchored eyes run summon minecraft:armor_stand ^ ^-0.3 ^0.3 {Fire:32767s,Marker:1b,Invulnerable:1b,Tags:["shot_ice","new"],ArmorItems:[{},{},{},{id:"minecraft:white_concrete",Count:1b}],Invisible:1b,DisabledSlots:2039583,Small:1b}
