...
execute at @s run function luigis_mansion:entities/bowser/move_foreward_fast
execute if entity @a[distance=..6,gamemode=!spectator] run tag @s remove run
execute if entity @a[distance=..6,gamemode=!spectator] run scoreboard players reset @s Time