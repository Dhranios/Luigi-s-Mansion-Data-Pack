...
execute if entity @s[scores={Dialog=3}] run playsound luigis_mansion:entity.nana.scream hostile @a ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=13}] run playsound luigis_mansion:entity.nana.scream hostile @a ~ ~ ~ 1
