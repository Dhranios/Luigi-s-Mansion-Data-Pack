summon minecraft:armor_stand ^ ^1 ^0.3 {ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:5,CustomModelData:0}}],Small:1b,Invisible:1b,Tags:["bannana_peel","new"]}
