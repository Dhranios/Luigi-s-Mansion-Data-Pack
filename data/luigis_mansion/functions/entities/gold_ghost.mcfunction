...
execute if entity @s[tag=!fleeing,tag=attack,scores={StunTime=0}] run function luigis_mansion:entities/gold_ghost/attack
...
execute if entity @s[tag=!fleeing,tag=!attack,tag=laugh,scores={StunTime=0}] run function luigis_mansion:entities/gold_ghost/laugh
execute if entity @s[tag=!fleeing,tag=!attack,tag=complain,scores={StunTime=0}] run function luigis_mansion:entities/gold_ghost/complain