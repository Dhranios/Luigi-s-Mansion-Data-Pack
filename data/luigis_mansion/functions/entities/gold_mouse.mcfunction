...
execute if entity @s[tag=dead,tag=tea_room_cheese] run loot spawn ~ ~ ~ loot luigis_mansion:entities/vacuumable/gold_mouse/tea_room_cheese
execute if entity @s[tag=dead,tag=fortune_tellers_room] run loot spawn ~ ~ ~ loot luigis_mansion:entities/vacuumable/gold_mouse/fortune_tellers_room
execute if entity @s[tag=dead,tag=safari_room] run loot spawn ~ ~ ~ loot luigis_mansion:entities/vacuumable/gold_mouse/safari_room
