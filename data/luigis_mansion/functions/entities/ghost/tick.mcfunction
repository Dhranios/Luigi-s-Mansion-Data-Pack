...
execute if entity @s[tag=dying,tag=hurt] run function luigis_mansion:entities/ghost/death
execute if entity @s[tag=dying,tag=element_death] run function luigis_mansion:entities/ghost/death_element
execute if entity @s[tag=dying,tag=element_hurt] run function luigis_mansion:entities/ghost/death_element
scoreboard players operation #temp Move = @s Move
execute unless score @s Time matches 1.. run tag @s[tag=disappear_next_tick,tag=vanish] add disappear
...
execute if entity @s[tag=boo,tag=!cutscene,tag=!spawned_health_display,tag=!dialog] run function luigis_mansion:entities/ghost/spawn_health_display
execute if entity @s[tag=king_boo,tag=battle,tag=!spawned_health_display,tag=!dialog] run function luigis_mansion:entities/ghost/spawn_health_display
tag @s[scores={VulnerableTime=0},tag=spawned_heart] remove spawned_heart
tag @s[scores={VulnerableTime=0},tag=!element_hurt,tag=!boo,tag=!king_boo,tag=spawned_health_display] remove spawned_health_display
...
execute if entity @s[tag=fleeing,tag=!vanish,tag=!disappear,tag=!vacuumable,tag=!dialog] run function luigis_mansion:entities/ghost/flee
