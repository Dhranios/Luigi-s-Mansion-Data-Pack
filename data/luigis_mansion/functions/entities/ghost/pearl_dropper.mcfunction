...
execute if entity @s[tag=slim_bankshot] store result score #temp Health run data get storage luigis_mansion:data current_state.current_data.portrait_ghosts.slim_bankshot.health
...
execute if entity @s[tag=uncle_grimmly] store result score #temp Health run data get storage luigis_mansion:data current_state.current_data.portrait_ghosts.uncle_grimmly.health
