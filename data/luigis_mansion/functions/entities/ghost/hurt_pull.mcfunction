...
execute if score #extra_damage Selected matches 0 run scoreboard players remove @s[scores={Room=1..}] Health 24
execute if score #extra_damage Selected matches 1 run scoreboard players remove @s[scores={Room=1..}] Health 36
