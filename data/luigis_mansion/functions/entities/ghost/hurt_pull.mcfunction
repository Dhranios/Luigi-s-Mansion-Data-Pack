...
execute if score #double_damage Selected matches 0 run scoreboard players remove @s Health 25
execute if score #double_damage Selected matches 1 run scoreboard players remove @s Health 50
