...
execute if entity @s[tag=dancing] store result score #temp Time run data get storage luigis_mansion:data current_state.ghost_caught.caught.dancing_ghost_guy
execute if entity @s[tag=dancing] store result storage luigis_mansion:data current_state.ghost_caught.caught.dancing_ghost_guy int 1 run scoreboard players add #temp Time 1
execute if entity @s[tag=!dancing] store result score #temp Time run data get storage luigis_mansion:data current_state.ghost_caught.caught.ghost_guy
execute if entity @s[tag=!dancing] store result storage luigis_mansion:data current_state.ghost_caught.caught.ghost_guy int 1 run scoreboard players add #temp Time 1
