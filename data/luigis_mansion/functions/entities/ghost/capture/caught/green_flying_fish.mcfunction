...
execute store result score #temp Time run data get storage luigis_mansion:data current_state.ghost_caught.caught.green_flying_fish
execute store result storage luigis_mansion:data current_state.ghost_caught.caught.green_flying_fish int 1 run scoreboard players add #temp Time 1
