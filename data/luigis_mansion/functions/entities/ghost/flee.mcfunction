...
execute if entity @s[tag=fleeing,tag=is_stopped] run scoreboard players set #temp Move 0
execute if entity @s[tag=fleeing,tag=is_pulled] run scoreboard players set #temp Move -4
