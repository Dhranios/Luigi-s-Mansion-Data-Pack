execute if entity @s[tag=normal_death] run playsound luigis_mansion:entity.speedy_spirit.vacumed hostile @a ~ ~ ~ 1
...
execute unless entity @e[distance=..0.7,type=minecraft:item] run loot spawn ~ ~ ~ loot luigis_mansion:entities/ghost/speedy_spirit