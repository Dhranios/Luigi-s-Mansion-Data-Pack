...
execute at @s[tag=stuck] unless block ~ ~ ~1 #luigis_mansion:all_ignore unless block ~ ~ ~1 #minecraft:slabs[type=bottom] run teleport @s ~ ~ ~ 0 ~
execute at @s[tag=stuck] unless block ~ ~ ~-1 #luigis_mansion:all_ignore unless block ~ ~ ~-1 #minecraft:slabs[type=bottom] run teleport @s ~ ~ ~ -180 ~
execute at @s[tag=stuck] unless block ~1 ~ ~ #luigis_mansion:all_ignore unless block ~1 ~ ~ #minecraft:slabs[type=bottom] run teleport @s ~ ~ ~ -90 ~
execute at @s[tag=stuck] unless block ~-1 ~ ~ #luigis_mansion:all_ignore unless block ~-1 ~ ~ #minecraft:slabs[type=bottom] run teleport @s ~ ~ ~ 90 ~
