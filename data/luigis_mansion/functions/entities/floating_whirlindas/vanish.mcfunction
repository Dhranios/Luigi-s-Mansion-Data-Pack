...
execute if entity @s[scores={ActionTime=1}] run data merge entity @e[tag=this_floating_whirlindas_body,limit=1] {Pose:{RightArm:[0.0f,0.0f,90.0f],LeftArm:[0.0f,0.0f,-90.0f],Head:[0.0f,0.0f,0.0f]}}
...
execute if entity @s[scores={ActionTime=1}] run data merge entity @e[tag=this_floating_whirlindas_female_body,limit=1] {Pose:{RightArm:[0.0f,0.0f,90.0f],LeftArm:[0.0f,0.0f,-90.0f],Head:[0.0f,0.0f,0.0f]}}
