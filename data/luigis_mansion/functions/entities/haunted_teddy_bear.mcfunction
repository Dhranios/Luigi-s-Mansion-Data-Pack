execute if entity @s[tag=dying,tag=normal_death,scores={HurtTime=1}] run playsound luigis_mansion:entity.haunted_teddy_bear.vacuumed hostile @a ~ ~ ~ 1
execute if entity @s[tag=dying,tag=element_death,scores={HurtTime=1}] run playsound luigis_mansion:entity.haunted_teddy_bear.element_death hostile @a ~ ~ ~ 1
...
execute if entity @s[tag=dead] run tag @e[tag=chauncey,scores={Room=9}] add complain
