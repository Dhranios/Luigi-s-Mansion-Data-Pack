...
summon minecraft:area_effect_cloud 707 104 33 {Tags:["choice"]}
summon minecraft:area_effect_cloud 715 102 31 {Tags:["choice"]}
summon minecraft:area_effect_cloud 708 102 28 {Tags:["choice"]}
summon minecraft:area_effect_cloud 715 102 25 {Tags:["choice"]}
summon minecraft:area_effect_cloud 707 104 23 {Tags:["choice"]}
...
summon minecraft:area_effect_cloud 708 104 35 {Tags:["choice"]}
summon minecraft:area_effect_cloud 708 104 20 {Tags:["choice"]}
summon minecraft:area_effect_cloud 712 105 36 {Tags:["choice"]}
summon minecraft:area_effect_cloud 707 105 30 {Tags:["choice"]}
summon minecraft:area_effect_cloud 707 105 28 {Tags:["choice"]}
summon minecraft:area_effect_cloud 707 105 25 {Tags:["choice"]}
