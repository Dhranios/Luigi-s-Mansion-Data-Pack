execute if entity @s[tag=dying,scores={AnimationProg=1}] run playsound luigis_mansion:entity.madame_clairvoya.vacumed hostile @a ~ ~ ~ 1
...
execute if entity @s[scores={AnimationProg=1},tag=hurt] run playsound luigis_mansion:entity.madame_clairvoya.hurt hostile @a ~ ~ ~ 1
