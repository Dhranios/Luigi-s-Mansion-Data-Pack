...
execute if entity @s[tag=spooky_bone] unless entity @s[x=679.5,y=101.2,z=50.5,distance=..0.4] run function luigis_mansion:entities/bone/spooky_bone
execute if entity @s[tag=spooky_bone] if entity @s[x=679.5,y=101.2,z=50.5,distance=..0.4] run data merge entity @s {Pose:{Head:[0.0f,0.0f,90.0f]}}
