...
execute if entity @a[gamemode=!spectator,distance=..0.7,limit=1] if entity @s[tag=vacuumable,tag=!in_vacuum,tag=!spit] run function luigis_mansion:entities/billiards_ball/collide
