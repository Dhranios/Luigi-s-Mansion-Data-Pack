...
execute if entity @s[scores={Time=1}] run playsound luigis_mansion:entity.red_grabbing_ghost.laugh hostile @a ~ ~ ~ 1
...
tag @s[scores={Time=60}] remove laugh
scoreboard players reset @s[scores={Time=60}] Time