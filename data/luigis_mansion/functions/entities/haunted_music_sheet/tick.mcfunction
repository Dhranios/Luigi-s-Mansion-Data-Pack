execute if entity @s[tag=dead,tag=normal_death] run playsound luigis_mansion:entity.haunted_music_sheet.vacuumed hostile @a ~ ~ ~ 1
execute if entity @s[tag=dead,tag=element_death] run playsound luigis_mansion:entity.haunted_music_sheet.element_death hostile @a ~ ~ ~ 1
