execute if entity @a[scores={ClairvoyaSpoke=5},limit=1] if entity @s[scores={VulnerableTime=0}] run function luigis_mansion:entities/madame_clairvoya/hidden/laugh
