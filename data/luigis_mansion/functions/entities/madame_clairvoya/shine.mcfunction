...
execute if entity @s[scores={PathStep=1..}] positioned ^ ^1 ^1.5 run particle minecraft:firework ~ ~ ~ 0.3 0.3 0.3 0 3
effect give @s[scores={PathStep=..99}] minecraft:invisibility 1 0 true
effect clear @s[scores={PathStep=100}] minecraft:invisibility
tag @s[scores={PathStep=100}] add visible
