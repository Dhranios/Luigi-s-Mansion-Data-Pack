...
execute positioned ^ ^1 ^1 if entity @e[tag=flashlight,distance=..3,limit=1] run scoreboard players add @s[scores={Time=..40}] Time 1
execute positioned ^ ^1 ^1 unless entity @e[tag=flashlight,distance=..3,limit=1] run scoreboard players set @s[scores={Time=..40}] Time 0
execute if entity @s[scores={Time=1..}] positioned ^ ^1 ^1 run particle minecraft:firework ~ ~ ~ 0.2 0.2 0.2 0 3
