...
execute positioned 712.5 103 -12.5 if entity @e[tag=flashlight,distance=..3,limit=1] run scoreboard players add @s[scores={Time=..40}] Time 1
execute positioned 712.5 103 -12.5 unless entity @e[tag=flashlight,distance=..3,limit=1] run scoreboard players set @s[scores={Time=..40}] Time 0
execute if entity @s[scores={Time=1..}] positioned 712.5 103 -12.5 run particle minecraft:firework ~ ~ ~ 0.2 0.2 0.2 0 3
