execute if entity @a[scores={ClairvoyaSpoke=5},limit=1] if entity @s[scores={VulnerableTime=0}] run function luigis_mansion:entities/madame_clairvoya/laugh
execute if entity @s[scores={VulnerableTime=1..}] as @a[scores={Room=16}] unless entity @s[scores={MusicType=36}] run function luigis_mansion:other/music/set/danger
