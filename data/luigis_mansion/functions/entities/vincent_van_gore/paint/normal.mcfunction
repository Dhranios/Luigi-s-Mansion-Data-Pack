...
execute if entity @s[scores={Time=332}] run function luigis_mansion:room/normal/artists_studio/wave_2 
execute if entity @s[scores={Time=332}] as @a[tag=same_room] run function luigis_mansion:other/music/set/mini_game
execute if entity @s[scores={Time=333}] run teleport @s ~ ~ ~ -180 ~
