execute unless entity @s[scores={Dialog=1..}] at @a[gamemode=!spectator,scores={Room=55}] positioned ^ ^ ^8 run effect give @s[distance=..8] minecraft:invisibility 1 0 true
...
execute if entity @s[scores={Dialog=30}] if score #players Totals matches 1 run tellraw @a[scores={Room=55}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.sir_weston","color":"green"},{"translate":"luigis_mansion:dialog.sir_weston.1"}]}
execute if entity @s[scores={Dialog=30}] if score #players Totals matches 2.. run tellraw @a[scores={Room=55}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.sir_weston","color":"green"},{"translate":"luigis_mansion:dialog.sir_weston.1.more"}]}
execute if entity @s[scores={Dialog=110}] run tellraw @a[scores={Room=55}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.sir_weston","color":"green"},{"translate":"luigis_mansion:dialog.sir_weston.2"}]}
execute if entity @s[scores={Dialog=198}] if score #players Totals matches 1 run tellraw @a[scores={Room=55}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.sir_weston","color":"green"},{"translate":"luigis_mansion:dialog.sir_weston.3"}]}
execute if entity @s[scores={Dialog=198}] if score #players Totals matches 2.. run tellraw @a[scores={Room=55}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.sir_weston","color":"green"},{"translate":"luigis_mansion:dialog.sir_weston.3.more"}]}
