...
execute if entity @s[scores={Room=60},tag=talk] if entity @a[advancements={luigis_mansion:lab/underground_lab=true}] run function luigis_mansion:dialog/underground_lab
