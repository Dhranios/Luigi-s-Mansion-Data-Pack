...
tag @s[scores={Room=10,HallwaySection=6},tag=area_3] add right
...
tag @s[scores={Room=37,HallwaySection=2}] add right
...
tag @s[scores={Room=41,HallwaySection=1}] add left
...
tag @s[scores={Room=41,HallwaySection=3},tag=area_4] add left
...
execute if entity @a[advancements={luigis_mansion:mansion/guest_room=true},limit=1] run tag @s[scores={Room=56}] add left
