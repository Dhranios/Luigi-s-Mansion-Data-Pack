...
tag @s[scores={Room=3}] add left
tag @s[scores={Room=3},tag=area_3] add right
tag @s[scores={Room=4},tag=area_3] add up
tag @s[scores={Room=4}] add down
tag @s[scores={Room=4,HallwaySection=1},tag=area_3] add left
tag @s[scores={Room=4}] add right
tag @s[scores={Room=6}] add up
tag @s[scores={Room=6,HallwaySection=1},tag=area_3] add down
tag @s[scores={Room=6,HallwaySection=1}] add left
tag @s[scores={Room=6,HallwaySection=2}] add down
tag @s[scores={Room=6,HallwaySection=2}] add right
...
tag @s[scores={Room=8}] add right
tag @s[scores={Room=9}] add up
tag @s[scores={Room=9},tag=area_3] add right
...
tag @s[scores={Room=10,HallwaySection=5}] add left
...
tag @s[scores={Room=10,HallwaySection=7},tag=area_3] add left
tag @s[scores={Room=10,HallwaySection=7}] add right
tag @s[scores={Room=10,HallwaySection=8}] add up
tag @s[scores={Room=10,HallwaySection=8}] add down
tag @s[scores={Room=10,HallwaySection=8},tag=area_3] add left
tag @s[scores={Room=10,HallwaySection=8}] add right
tag @s[scores={Room=10,HallwaySection=9},tag=area_3] add up
tag @s[scores={Room=10,HallwaySection=9}] add down
tag @s[scores={Room=10,HallwaySection=9}] add left
...
tag @s[scores={Room=12}] add right
tag @s[scores={Room=13}] add up
tag @s[scores={Room=13,HallwaySection=1}] add down
tag @s[scores={Room=13}] add left
tag @s[scores={Room=13,HallwaySection=1}] add right
tag @s[scores={Room=14}] add down
tag @s[scores={Room=14}] add left
tag @s[scores={Room=14,HallwaySection=2}] add up
tag @s[scores={Room=14,HallwaySection=2}] add right
tag @s[scores={Room=15}] add up
tag @s[scores={Room=15},tag=area_3] add down
tag @s[scores={Room=15}] add right
tag @s[scores={Room=16}] add up
tag @s[scores={Room=16}] add right
tag @s[scores={Room=17}] add left
tag @s[scores={Room=18}] add up
tag @s[scores={Room=18}] add down
tag @s[scores={Room=18}] add right
tag @s[scores={Room=19}] add up
tag @s[scores={Room=19}] add right
tag @s[scores={Room=20}] add up
tag @s[scores={Room=20}] add left
tag @s[scores={Room=21}] add down
tag @s[scores={Room=21}] add left
tag @s[scores={Room=21},tag=area_3] add right
...
tag @s[scores={Room=23,HallwaySection=1}] add left
tag @s[scores={Room=23}] add right
tag @s[scores={Room=28}] add left
...
tag @s[scores={Room=31,HallwaySection=2}] add left
tag @s[scores={Room=31,HallwaySection=2},tag=area_4] add right
tag @s[scores={Room=31,HallwaySection=3},tag=area_4] add down
tag @s[scores={Room=31,HallwaySection=3}] add left
tag @s[scores={Room=31,HallwaySection=4}] add up
tag @s[scores={Room=31,HallwaySection=4},tag=area_4] add down
tag @s[scores={Room=31,HallwaySection=4}] add left
...
tag @s[scores={Room=31,HallwaySection=7}] add left
...
tag @s[scores={Room=32}] add right
tag @s[scores={Room=33}] add down
tag @s[scores={Room=33}] add right
...
tag @s[scores={Room=35}] add left
tag @s[scores={Room=37}] add up
tag @s[scores={Room=37}] add down
tag @s[scores={Room=37,HallwaySection=1}] add left
tag @s[scores={Room=37}] add right
...
tag @s[scores={Room=39}] add left
tag @s[scores={Room=40}] add left
tag @s[scores={Room=41,HallwaySection=1}] add up
tag @s[scores={Room=41,HallwaySection=2},tag=area_4] add up
tag @s[scores={Room=41,HallwaySection=2}] add right
...
tag @s[scores={Room=41,HallwaySection=4},tag=area_4] add right
...
tag @s[scores={Room=44,HallwaySection=1}] add left
tag @s[scores={Room=45}] add left
tag @s[scores={Room=46}] add left
tag @s[scores={Room=47,HallwaySection=1}] add up
tag @s[scores={Room=47}] add left
tag @s[scores={Room=47,HallwaySection=1}] add right
...
tag @s[scores={Room=47,HallwaySection=3}] add right
tag @s[scores={Room=49}] add down
tag @s[scores={Room=49}] add left
tag @s[scores={Room=51}] add up
tag @s[scores={Room=51}] add right
tag @s[scores={Room=52}] add down
tag @s[scores={Room=52}] add right
tag @s[scores={Room=54}] add down
tag @s[scores={Room=54}] add right
tag @s[scores={Room=55}] add up
tag @s[scores={Room=55}] add right
tag @s[scores={Room=56}] add up
execute if data storage luigis_mansion:data current_state.current_data.rooms.guest_room{cleared:1b} run tag @s[scores={Room=56}] add right
