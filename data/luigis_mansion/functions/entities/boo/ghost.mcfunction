...
execute at @s[tag=!fleeing,tag=!attack,tag=!laugh,tag=!taunt,tag=!boo_hurt] unless entity @s[tag=!fleeing,tag=!attack,tag=!laugh,tag=!taunt,tag=!boo_hurt,tag=!up,tag=!down,tag=!left,tag=!right] run function luigis_mansion:entities/boo/move_forward
execute at @s[tag=!fleeing,tag=!attack,tag=!laugh,tag=!taunt,tag=!boo_hurt,tag=!up,tag=!down,tag=!left,tag=!right] run function luigis_mansion:entities/boo/move_forward_no_direction
execute if entity @s[scores={Time=60..}] run function luigis_mansion:entities/boo/turn
