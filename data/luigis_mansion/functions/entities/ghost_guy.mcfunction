...
execute if entity @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=!maskless,tag=stop_dancing,scores={StunTime=0}] positioned ^ ^ ^0.7 if entity @a[gamemode=!spectator,distance=..0.7,limit=1] run tag @s add attack
...
execute at @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=!dodge,tag=!complain,tag=stop_dancing,scores={StunTime=0,Distance=0,WaitTime=0}] run function luigis_mansion:entities/ghost_guy/target
execute at @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=!dodge,tag=!complain,tag=stop_dancing,scores={StunTime=0,Distance=1..,WaitTime=0}] run function luigis_mansion:entities/ghost_guy/move
execute at @s[tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=!dodge,tag=!complain,tag=!stop_dancing,scores={StunTime=0}] run function luigis_mansion:entities/ghost_guy/dance
