...
tag @s[tag=!grabbed,nbt={SelectedItem:{tag:{luigis_mansion:{id:"luigis_mansion:flashlight"}}}}] add flashlight
...
scoreboard players set @s[tag=flashlight,scores={UseItem=1}] UseItem 0
