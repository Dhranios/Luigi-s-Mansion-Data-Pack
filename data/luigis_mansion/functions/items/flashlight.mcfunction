...
execute if entity @s[tag=flashlight] as @e[distance=..7,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog,scores={StunTime=0}] positioned ^ ^ ^4 if entity @s[distance=..4] at @s run playsound luigis_mansion:entity.heart.flash hostile @a ~ ~ ~ 1
...
execute if entity @s[tag=flashlight] as @e[distance=6..7,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 10
execute if entity @s[tag=flashlight] as @e[distance=6..7,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 10
execute if entity @s[tag=flashlight] as @e[distance=5..6,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 20
execute if entity @s[tag=flashlight] as @e[distance=5..6,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 20
execute if entity @s[tag=flashlight] as @e[distance=4..5,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 30
execute if entity @s[tag=flashlight] as @e[distance=4..5,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 30
execute if entity @s[tag=flashlight] as @e[distance=3..4,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 40
execute if entity @s[tag=flashlight] as @e[distance=3..4,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 40
execute if entity @s[tag=flashlight] as @e[distance=2..3,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 50
execute if entity @s[tag=flashlight] as @e[distance=2..3,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 50
execute if entity @s[tag=flashlight] as @e[distance=1..2,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 60
execute if entity @s[tag=flashlight] as @e[distance=1..2,tag=stunable,tag=!vanish,tag=!appear,tag=!hurt_animation,tag=!hurt,tag=!element_hurt,tag=!last_element_hurt,tag=!dialog] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 60
