...
execute if entity @s[tag=flashlight] as @e[distance=5..6,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 20
execute if entity @s[tag=flashlight] as @e[distance=4..5,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 30
execute if entity @s[tag=flashlight] as @e[distance=4..5,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 30
execute if entity @s[tag=flashlight] as @e[distance=3..4,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 40
execute if entity @s[tag=flashlight] as @e[distance=3..4,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 40
execute if entity @s[tag=flashlight] as @e[distance=2..3,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 50
execute if entity @s[tag=flashlight] as @e[distance=2..3,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 50
execute if entity @s[tag=flashlight] as @e[distance=1..2,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 60
execute if entity @s[tag=flashlight] as @e[distance=1..2,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 60
execute if entity @s[tag=flashlight] as @e[distance=..1,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={VulnerableTime=0}] VulnerableTime 70
execute if entity @s[tag=flashlight] as @e[distance=..1,tag=stunable] positioned ^ ^ ^4 run scoreboard players set @s[distance=..4,scores={StunTime=0}] StunTime 70

execute if entity @s[tag=flashlight] as @e[distance=..7,tag=stunable,scores={StunTime=1}] positioned ^ ^ ^4 run tag @s[distance=..4] add disappear
