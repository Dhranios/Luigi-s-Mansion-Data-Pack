...
execute if entity @s[tag=!already_included] if data entity @s ArmorItems[3].tag.attacked_by run data modify entity @s ArmorItems[3].tag.attacked_by append from block 27 0 0 Items[0].tag.Value
