...
execute if entity @s[tag=!already_included] if data storage luigis_mansion:ghost_list IDs[0] run function luigis_mansion:items/poltergust_3000/search_my_id