...
execute positioned ~ ~-1.3 ~ as @e[tag=vacuumable,distance=..0.7,tag=money] positioned as @s positioned ~ ~1.3 ~ if block ^ ^ ^0.3 #luigis_mansion:ghosts_ignore positioned ~ ~-1.3 ~ run function luigis_mansion:entities/money/pull
