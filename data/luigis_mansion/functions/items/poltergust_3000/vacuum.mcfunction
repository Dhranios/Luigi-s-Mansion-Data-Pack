...
execute as @e[type=minecraft:item,distance=..0.7] positioned as @s if block ^ ^ ^0.3 #luigis_mansion:items_ignore run teleport @s ^ ^ ^0.1
execute as @e[type=minecraft:item,distance=..0.7] positioned as @s unless block ^ ^ ^0.3 #luigis_mansion:items_ignore rotated ~ 0 if block ^ ^ ^0.3 #luigis_mansion:items_ignore run teleport @s ^ ^ ^0.1
