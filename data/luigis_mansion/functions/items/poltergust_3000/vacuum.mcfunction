...
execute as @e[type=minecraft:item,distance=..0.7,tag=!elemental_ghost] positioned as @s if block ^ ^ ^0.3 #luigis_mansion:items_ignore run teleport @s ^ ^ ^0.1
execute as @e[type=minecraft:item,distance=..0.7,tag=!elemental_ghost] positioned as @s unless block ^ ^ ^0.3 #luigis_mansion:items_ignore rotated ~ 0 if block ^ ^ ^0.3 #luigis_mansion:items_ignore run teleport @s ^ ^ ^0.1
execute as @e[tag=vacuumable,distance=..0.7] unless entity @s[tag=ball,tag=spit] unless entity @s[tag=haunted_object,tag=!moving,tag=!haunted_music_sheet] positioned as @s if block ^ ^ ^0.3 #luigis_mansion:ghosts_ignore unless entity @a[gamemode=!spectator,distance=..1.2,limit=1] run teleport @s ^ ^ ^0.1
...
execute as @e[tag=ball,distance=..0.7,tag=!spit] unless entity @s[tag=chauncey] run tag @s add in_vacuum
...
execute if entity @s[tag=pull_boo] as @e[tag=boo,distance=..0.7,tag=!dead,tag=!hurt] run tag @s add is_pulled
