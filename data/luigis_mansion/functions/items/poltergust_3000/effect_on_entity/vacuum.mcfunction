...
execute if entity @s[tag=vacuumable,tag=!boolossus,tag=!shining_ghost] unless entity @s[tag=haunted_object,tag=!moving,tag=!haunted_music_sheet] positioned as @s if block ^ ^ ^0.3 #luigis_mansion:ghosts_ignore unless entity @a[tag=me,distance=..1.2,limit=1] run teleport @s ^ ^ ^0.1
...
execute if entity @s[tag=vacuumable,tag=!spark,tag=!boolossus] unless entity @s[tag=haunted_object,tag=!moving,tag=!haunted_music_sheet] positioned as @s if entity @a[tag=me,distance=..1.2,limit=1] run tag @s add normal_death
execute if entity @s[tag=vacuumable,tag=!spark,tag=!boolossus,tag=!ghost] unless entity @s[tag=haunted_object,tag=!moving,tag=!haunted_music_sheet] positioned as @s if entity @a[tag=me,distance=..1.2,limit=1] run tag @s add dead
execute if entity @s[tag=vacuumable,tag=!spark,tag=!boolossus] unless entity @s[tag=haunted_object,tag=!moving,tag=!haunted_music_sheet] positioned as @s if entity @a[tag=me,distance=..1.2,limit=1] run function luigis_mansion:items/poltergust_3000/latch_onto_ghost
