...
execute as @e[tag=vacuumable,distance=..0.7,tag=!ball] unless entity @s[tag=haunted_object,tag=!moving] run tag @s add dead
...
tag @e[tag=ghost,distance=..0.7,tag=!watery_heart,tag=!frozen_heart,tag=!portrait_ghost,tag=!boo] add element_hurt
