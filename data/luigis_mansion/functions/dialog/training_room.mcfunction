...
execute if entity @s[scores={Dialog=1646}] if score #training Totals matches ..3 if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.16.bad"}]}
execute if entity @s[scores={Dialog=1646}] if score #training Totals matches ..3 if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.16.bad.more"}]}
execute if entity @s[scores={Dialog=1646}] if score #training Totals matches 4.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.16.good"}]}
execute if entity @s[scores={Dialog=1646}] if score #training Totals matches 4.. run scoreboard players add @s Dialog 32
...
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 0 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.0"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 0 run scoreboard players add @s Dialog 56
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.1"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 1 run scoreboard players add @s Dialog 48
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 2 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.2"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 2 run scoreboard players add @s Dialog 56
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 3 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.3"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 3 run scoreboard players add @s Dialog 56
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 4 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.4"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 4 run scoreboard players add @s Dialog 48
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 5 if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.5","with":[{"selector":"@a[gamemode=!spectator]"}]}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 5 if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.5.more"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 6 if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.6","with":[{"selector":"@a[gamemode=!spectator]"}]}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 6 if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.6.more"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 6 run scoreboard players add @s Dialog 40
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 7 if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.7","with":[{"selector":"@a[gamemode=!spectator]"}]}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 7 if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.7.more"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 7 run scoreboard players add @s Dialog 8
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 8 if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.8","with":[{"selector":"@a[gamemode=!spectator]"}]}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 8 if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.8.more"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 8 run scoreboard players add @s Dialog 16
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 9 if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.9","with":[{"selector":"@a[gamemode=!spectator]"}]}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 9 if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.9.more"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 9 run scoreboard players add @s Dialog 32
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 10 if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.10","with":[{"selector":"@a[gamemode=!spectator]"}]}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 10 if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.10.more"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 10 run scoreboard players add @s Dialog 32
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 11 if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.11","with":[{"selector":"@a[gamemode=!spectator]"}]}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 11 if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.21.11.more"}]}
execute if entity @s[scores={Dialog=2004}] if score #training Totals matches 11 run scoreboard players add @s Dialog 16
execute if entity @s[scores={Dialog=2100}] if score #training Totals matches ..3 if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.22.bad"}]}
execute if entity @s[scores={Dialog=2100}] if score #training Totals matches ..3 if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.22.bad.more"}]}
execute if entity @s[scores={Dialog=2100}] if score #training Totals matches ..3 run scoreboard players add @s Dialog 16
execute if entity @s[scores={Dialog=2100}] if score #training Totals matches 4.. if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.22.good"}]}
execute if entity @s[scores={Dialog=2100}] if score #training Totals matches 4.. if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.22.good.more"}]}
...
execute if entity @s[scores={Dialog=2424}] run scoreboard players set #training Totals 0
