...
execute if entity @s[scores={Time=40}] run setblock 674 102 39 minecraft:andesite_stairs[facing=south,shape=straight,half=bottom]
execute if entity @s[scores={Time=40}] run setblock 674 103 38 minecraft:oak_fence[south=true]
...
execute if entity @s[scores={Time=160}] run summon minecraft:item_frame 673 104 33 {Facing:5b,CustomName:'{"translate":"luigis_mansion:entity.poster"}',Fixed:1b,Invisible:1b,Silent:1b,Item:{id:"minecraft:filled_map",Count:1b,tag:{map:151}},Tags:["poster"]}
