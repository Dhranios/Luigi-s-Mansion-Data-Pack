...
execute if entity @s[scores={Dialog=706}] if entity @a[scores={Toad4Choice=1}] run playsound luigis_mansion:entity.toad.wow neutral @a[scores={Room=26}] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=786}] if entity @a[scores={Toad4Choice=1}] run playsound luigis_mansion:entity.toad.yahoo neutral @a[scores={Room=26}] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=706}] if entity @a[scores={Toad4Choice=2}] run playsound luigis_mansion:entity.toad.mama_mia neutral @a[scores={Room=26}] ~ ~ ~ 1
