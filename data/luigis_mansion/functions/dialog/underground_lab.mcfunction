...
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=3},limit=1] run tellraw @a[scores={Room=60}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.underground_lab.training.1"}]}
execute if entity @s[scores={Dialog=74}] if entity @a[scores={EGaddLabChoice=3},limit=1] as @a[scores={Room=60}] run function luigis_mansion:entities/e_gadd/to_training
execute if entity @s[scores={Dialog=74}] if entity @a[scores={EGaddLabChoice=3},limit=1] run scoreboard players set @s Dialog 148
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=4},limit=1] run tellraw @a[scores={Room=60}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.underground_lab.gallery.1"}]}
execute if entity @s[scores={Dialog=82}] if entity @a[scores={EGaddLabChoice=4},limit=1] as @a[scores={Room=60}] run function luigis_mansion:entities/e_gadd/to_gallery
execute if entity @s[scores={Dialog=82}] if entity @a[scores={EGaddLabChoice=4},limit=1] run scoreboard players set @s Dialog 148
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=5},limit=1] run tellraw @a[scores={Room=60}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.underground_lab.portrificationizer.1"}]}
execute if entity @s[scores={Dialog=82}] if entity @a[scores={EGaddLabChoice=5},limit=1] as @a[scores={Room=60}] run function luigis_mansion:entities/e_gadd/to_portrificationizer
execute if entity @s[scores={Dialog=82}] if entity @a[scores={EGaddLabChoice=5},limit=1] run scoreboard players set @s Dialog 148
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=6},limit=1] if score #players Totals matches 1 run tellraw @a[scores={Room=60}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.underground_lab.old_data.1"}]}
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=6},limit=1] if score #players Totals matches 2.. run tellraw @a[scores={Room=60}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.underground_lab.old_data.1.more"}]}
execute if entity @s[scores={Dialog=130}] if entity @a[scores={EGaddLabChoice=6},limit=1] run tellraw @a[scores={Room=60}] {"translate":"luigis_mansion:message.options","color":"green","extra":[{"text":"\n"},{"translate":"luigis_mansion:dialog.underground_lab.old_data.yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger EGaddLabChoice set 1"}},{"text":"\n"},{"translate":"luigis_mansion:dialog.underground_lab.old_data.no","color":"green","clickEvent":{"action":"run_command","value":"/trigger EGaddLabChoice set 2"}}]}
execute if entity @s[scores={Dialog=130}] if entity @a[scores={EGaddLabChoice=6},limit=1] run scoreboard players enable @a[scores={Room=60},gamemode=!spectator] EGaddLabChoice
...
execute if entity @s[scores={Dialog=132}] if entity @a[scores={EGaddLabChoice=2},limit=1] run tellraw @a[scores={Room=60}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.underground_lab.old_data.no.1"}]}
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=7},limit=1] run tellraw @a[scores={Room=60}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.underground_lab.nowhere.1"}]}
