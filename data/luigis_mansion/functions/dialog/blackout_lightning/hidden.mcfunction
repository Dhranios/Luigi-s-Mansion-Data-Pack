...
execute if entity @s[scores={Time=70..}] run function luigis_mansion:dialog/blackout_lightning/particles_hidden
execute if entity @s[scores={Time=130}] as @e[type=!minecraft:player,limit=1] run function luigis_mansion:dialog/blackout_lightning/reset_hidden
