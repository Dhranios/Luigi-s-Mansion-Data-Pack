...
execute if entity @s[scores={Dialog=1}] if entity @a[advancements={luigis_mansion:boos/boos=false}] if score #players Totals matches 1 run tellraw @a[scores={Room=1}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.repeat"}]}
execute if entity @s[scores={Dialog=1}] if entity @a[advancements={luigis_mansion:boos/boos=false}] if score #players Totals matches 2.. run tellraw @a[scores={Room=1}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.repeat.more"}]}
execute if entity @s[scores={Dialog=1}] if entity @a[advancements={luigis_mansion:boos/boos=true,luigis_mansion:mansion/breaker_room=false}] if score #players Totals matches 1 run tellraw @a[scores={Room=1}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.repeat.boos","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={Dialog=1}] if entity @a[advancements={luigis_mansion:boos/boos=true,luigis_mansion:mansion/breaker_room=false}] if score #players Totals matches 2.. run tellraw @a[scores={Room=1}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.repeat.boos.more"}]}
execute if entity @s[scores={Dialog=1}] if entity @a[advancements={luigis_mansion:mansion/breaker_room=true}] run tellraw @a[scores={Room=1}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.repeat.blackout"}]}
...
execute if entity @s[scores={Dialog=128}] run tellraw @a[scores={Room=1}] {"translate":"luigis_mansion:message.options","color":"green","extra":[{"text":"\n"},{"translate":"luigis_mansion:message.save.yes","clickEvent":{"action":"run_command","value":"/trigger Toad1Choice set 1"}},{"text":"\n"},{"translate":"luigis_mansion:message.save.no","clickEvent":{"action":"run_command","value":"/trigger Toad1Choice set 2"}}]}
execute if entity @s[scores={Dialog=128}] run scoreboard players enable @a[scores={Room=1},gamemode=!spectator] Toad1Choice
