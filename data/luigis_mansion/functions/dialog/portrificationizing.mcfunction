...
execute if entity @s[scores={Dialog=810}] if data storage luigis_mansion:data current_state.current_data.money{gold_coin:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=830}] if data storage luigis_mansion:data current_state.current_data.money{bill:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=850}] if data storage luigis_mansion:data current_state.current_data.money{gold_bar:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=870}] if data storage luigis_mansion:data current_state.current_data.money{blue_sapphire:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=890}] if data storage luigis_mansion:data current_state.current_data.money{green_emerald:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=910}] if data storage luigis_mansion:data current_state.current_data.money{red_ruby:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=930}] if data storage luigis_mansion:data current_state.current_data.money{blue_diamond:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=950}] if data storage luigis_mansion:data current_state.current_data.money{red_diamond:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=970}] if data storage luigis_mansion:data current_state.current_data.money{gold_diamond:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=990}] if data storage luigis_mansion:data current_state.current_data.money{small_pearl:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=1010}] if data storage luigis_mansion:data current_state.current_data.money{medium_pearl:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
...
execute if entity @s[scores={Dialog=1030}] if data storage luigis_mansion:data current_state.current_data.money{big_pearl:0} run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
execute if entity @s[scores={Dialog=1050}] run scoreboard players reset #temp2
execute if entity @s[scores={Dialog=1050},tag=ending] store result score #temp2 Money run data get storage luigis_mansion:data current_state.current_data.high_score
...
execute if entity @s[scores={Dialog=1050},tag=ending] store result storage luigis_mansion:data current_state.current_data.high_score int 1 run scoreboard players get #temp2 Money
...
execute if entity @s[scores={Dialog=1050},tag=ending] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.high_score","with":[{"score":{"objective":"Money","name":"#temp2"}}]}]}
