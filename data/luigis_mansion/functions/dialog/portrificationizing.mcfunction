...
execute if entity @s[scores={Dialog=1050},tag=ending] unless score #total Money >= #temp Money run scoreboard players operation #total Money = #temp Money
...
execute if entity @s[scores={Dialog=1050},tag=ending] if score #total Money matches 1.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.high_score","with":[{"score":{"objective":"Money","name":"#total"}}]}]}
execute if entity @s[scores={Dialog=1050},tag=ending] unless score #total Money matches 1.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.not_obtained"}]}
