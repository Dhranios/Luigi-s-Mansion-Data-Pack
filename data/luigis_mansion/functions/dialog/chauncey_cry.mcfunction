...
execute if entity @s[scores={Time=1}] if score #mansion_type Selected matches 1 run playsound luigis_mansion:entity.chauncey.cry hostile @a 705 112 44 3
...
execute if entity @s[scores={Time=10}] if score #mansion_type Selected matches 1 run playsound luigis_mansion:entity.chauncey.cry hostile @a 705 112 44 3
