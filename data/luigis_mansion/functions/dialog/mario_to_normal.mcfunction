...
execute if entity @s[scores={Dialog=1}] run setblock 769 77 -12 minecraft:light_gray_concrete
execute if entity @s[scores={Dialog=1}] run summon minecraft:item_frame 770 77 -12 {Facing:5b,ItemRotation:0b,Invulnerable:1b,Item:{},Tags:["marios_painting"]}
execute if entity @s[scores={Dialog=10}] run setblock 769 77 -12 minecraft:air
execute if entity @s[scores={Dialog=10}] run setblock 769 78 -12 minecraft:light_gray_concrete
