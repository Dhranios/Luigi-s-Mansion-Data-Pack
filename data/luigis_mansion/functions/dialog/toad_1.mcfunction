...
execute if entity @s[scores={Dialog=944}] run scoreboard players enable @a[gamemode=!spectator] Toad1Choice
...
execute if entity @s[scores={Dialog=946}] if entity @a[scores={Toad1Choice=1}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.yes.1","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={Dialog=946}] if entity @a[scores={Toad1Choice=1}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.yes.1.more"}]}
execute if entity @s[scores={Dialog=1042}] if entity @a[scores={Toad1Choice=1}] if score #mansion_type Selected matches 0 run function luigis_mansion:room/normal/foyer/clear
execute if entity @s[scores={Dialog=1042}] if entity @a[scores={Toad1Choice=1}] if score #mansion_type Selected matches 1 run function luigis_mansion:room/hidden/foyer/clear
execute if entity @s[scores={Dialog=1062}] if entity @a[scores={Toad1Choice=1}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.yes.2"}]}
execute if entity @s[scores={Dialog=1062}] if entity @a[scores={Toad1Choice=1}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.yes.2.more"}]}
execute if entity @s[scores={Dialog=1166}] if entity @a[scores={Toad1Choice=1}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.yes.3"}]}
execute if entity @s[scores={Dialog=946}] if entity @a[scores={Toad1Choice=2}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.no.1"}]}
execute if entity @s[scores={Dialog=946}] if entity @a[scores={Toad1Choice=2}] run scoreboard players add @s Dialog 236
