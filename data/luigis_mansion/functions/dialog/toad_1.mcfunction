...
execute if entity @s[scores={Dialog=224}] if score #players Totals matches 1 run tellraw @a[scores={Room=1}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.4"}]}
...
execute if entity @s[scores={Dialog=1042}] if score #mansion_type Selected matches 1 run function luigis_mansion:room/hidden/foyer/clear
execute if entity @s[scores={Dialog=1062}] if score #players Totals matches 1 run tellraw @a[scores={Room=1}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.yes.2"}]}
execute if entity @s[scores={Dialog=1062}] if score #players Totals matches 2.. run tellraw @a[scores={Room=1}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.yes.2.more"}]}
execute if entity @s[scores={Dialog=1166}] run scoreboard players set @a Toad1Choice 0
execute if entity @s[scores={Dialog=1166}] run tellraw @a[scores={Room=1}] {"translate":"luigis_mansion:message.options","color":"green","extra":[{"text":"\n"},{"translate":"luigis_mansion:message.save.yes","clickEvent":{"action":"run_command","value":"/trigger Toad1Choice set 1"}},{"text":"\n"},{"translate":"luigis_mansion:message.save.no","clickEvent":{"action":"run_command","value":"/trigger Toad1Choice set 2"}}]}
