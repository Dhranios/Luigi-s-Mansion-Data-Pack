...
execute if entity @s[scores={Dialog=192}] as @e[tag=gold_ghost,tag=dialog,limit=1] at @s run teleport @s ~ ~ ~ facing 690 112.3 15
...
execute if entity @s[scores={Dialog=294..352}] as @e[tag=gold_ghost,tag=dialog,limit=1] at @s facing 689 112.3 6 rotated ~ 0 run teleport @s ^ ^ ^0.077
...
execute if entity @s[scores={Dialog=268..287}] facing 695 112 12 rotated ~ 0 run teleport @s ^ ^ ^0.2
execute if entity @s[scores={Dialog=287..316}] facing 693 112 6 rotated ~ 0 run teleport @s ^ ^ ^0.2
execute if entity @s[scores={Dialog=317..352}] facing 689 112 6 rotated ~ 0 run teleport @s ^ ^ ^0.1
execute if entity @s[scores={Dialog=353..372}] facing 695 112 6 rotated ~ 0 run teleport @s ^ ^ ^0.25
...
execute if entity @s[scores={Dialog=846}] run teleport @s ~ ~ ~ facing 694 112 16
...
execute if entity @s[scores={Dialog=1107}] positioned 688 112 9 run function luigis_mansion:spawn_entities/ghost/gold_ghost
execute if entity @s[scores={Dialog=1107}] positioned 688 112 9 run tag @e[distance=..0.1,tag=gold_ghost] add dialog
execute if entity @s[scores={Dialog=1122}] positioned 688 112 6 run function luigis_mansion:spawn_entities/ghost/gold_ghost
execute if entity @s[scores={Dialog=1122}] positioned 688 112 6 run tag @e[distance=..0.1,tag=gold_ghost] add dialog
execute if entity @s[scores={Dialog=1137}] positioned 690 112 7 run function luigis_mansion:spawn_entities/ghost/gold_ghost
execute if entity @s[scores={Dialog=1137}] positioned 690 112 7 run tag @e[distance=..0.1,tag=gold_ghost] add dialog
