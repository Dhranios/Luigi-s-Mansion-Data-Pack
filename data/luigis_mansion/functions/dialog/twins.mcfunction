...
execute if entity @s[scores={Dialog=168}] if entity @a[scores={TwinsChoice=1}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.orville","color":"green"},{"translate":"luigis_mansion:dialog.twins.3"}]}
...
execute if entity @s[scores={Dialog=208}] run scoreboard players enable @a[gamemode=!spectator] TwinsChoice
...
execute if entity @s[scores={Dialog=210}] if entity @a[scores={TwinsChoice=1}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.henry","color":"green"},{"translate":"luigis_mansion:dialog.twins.yes.1"}]}
execute if entity @s[scores={Dialog=218}] if entity @a[scores={TwinsChoice=1}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.orville","color":"green"},{"translate":"luigis_mansion:dialog.twins.yes.2"}]}
execute if entity @s[scores={Dialog=218}] if entity @a[scores={TwinsChoice=1}] run scoreboard players set #twins_room Wave 3
execute if entity @s[scores={Dialog=210}] if entity @a[scores={TwinsChoice=2}] run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.orville","color":"green"},{"translate":"luigis_mansion:dialog.twins.no.1"}]}
