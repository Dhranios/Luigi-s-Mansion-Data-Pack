...
execute if entity @s[scores={Dialog=553},advancements={luigis_mansion:lab/ghost_portrificationizer_room=true}] run tag @e[tag=e_gadd,scores={Room=62},limit=1] add return_dialog
execute if entity @s[scores={Dialog=553},advancements={luigis_mansion:lab/ghost_portrificationizer_room=false}] run tag @e[tag=e_gadd,scores={Room=62},limit=1] add talk
scoreboard players set @s[scores={Dialog=553}] GBHCall 0
scoreboard players set @s[scores={Dialog=553}] GBHWait 0
scoreboard players reset @s[scores={Dialog=553}] Dialog