...
execute if entity @s[scores={Dialog=140..}] if score #mansion_type Selected matches 0 positioned 677 101 -18 rotated -180 0 run function luigis_mansion:dialog/release_boos/boos
execute if entity @s[scores={Dialog=140..}] if score #mansion_type Selected matches 1 positioned 677 101 33 rotated 0 0 run function luigis_mansion:dialog/release_boos/boos
