execute if entity @s[tag=loaded_chunk_10] run function luigis_mansion:dialog/play

# Trigger areas
execute if entity @s[scores={Dialog=0},gamemode=!creative,gamemode=!spectator] run function luigis_mansion:dialog/trigger_area
