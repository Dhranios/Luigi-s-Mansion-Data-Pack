...
execute if entity @s[scores={Dialog=1}] run playsound luigis_mansion:entity.toad.cry_0 neutral @a[scores={Room=5}] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=1}] run playsound luigis_mansion:entity.toad.wow neutral @a[scores={Room=5}] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=216}] if score #mansion_type Selected matches 0 run function luigis_mansion:room/normal/balcony_1/clear
execute if entity @s[scores={Dialog=216}] if score #mansion_type Selected matches 1 run function luigis_mansion:room/hidden/balcony_1/clear
