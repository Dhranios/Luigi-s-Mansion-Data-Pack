...
data modify entity @s[scores={AnimationProg=4},tag=!fight] ArmorItems[3].tag merge value {Unbreakable:1b,Damage:2,CustomModelData:116}
data modify entity @s[scores={AnimationProg=12},tag=!fight] ArmorItems[3].tag merge value {Unbreakable:1b,Damage:1,CustomModelData:113}
data modify entity @s[scores={AnimationProg=4},tag=fight] ArmorItems[3].tag merge value {Unbreakable:1b,Damage:1,CustomModelData:116}
data modify entity @s[scores={AnimationProg=12},tag=fight] ArmorItems[3].tag merge value {Unbreakable:1b,Damage:1,CustomModelData:115}