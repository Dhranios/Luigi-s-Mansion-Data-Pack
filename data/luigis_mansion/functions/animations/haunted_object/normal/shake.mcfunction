...
execute if entity @s[scores={HomeRotY=0,AnimationProg=1}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 4
execute if entity @s[scores={HomeRotY=0,AnimationProg=2..3}] store result entity @s Pose.Head[2] float 1 run scoreboard players remove #temp Time 4
execute if entity @s[scores={HomeRotY=0,AnimationProg=4}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 4
