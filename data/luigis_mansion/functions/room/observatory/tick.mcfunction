...
execute as @e[team=Ghost,x=672,y=112,z=-44,dx=11,dy=6,dz=12] unless entity @s[scores={Room=1..}] run scoreboard players set @s Room 36
execute as @e[team=Ghost,x=667,y=112,z=-105,dx=16,dy=6,dz=61] unless entity @s[scores={Room=1..}] run scoreboard players set @s Room 36
