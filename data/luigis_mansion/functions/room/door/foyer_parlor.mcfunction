...
execute if entity @a[gamemode=!spectator,distance=..5,x=698.5,y=112,z=8.0] if score #temp Searched matches 1 run scoreboard players set #temp Searched 2
execute unless entity @a[gamemode=!spectator,distance=..5,x=698.5,y=112,z=8.0] if score #temp Searched matches 1 run scoreboard players set #temp Searched 0
