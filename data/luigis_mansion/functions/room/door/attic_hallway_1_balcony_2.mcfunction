...
execute if score #temp Searched matches 0 run setblock 684 122 -12 minecraft:oak_door[open=false,facing=west,half=lower,hinge=right,powered=false]
execute if score #temp Searched matches 0 run setblock 682 122 -12 minecraft:oak_door[open=false,facing=east,half=lower,hinge=left,powered=false]
