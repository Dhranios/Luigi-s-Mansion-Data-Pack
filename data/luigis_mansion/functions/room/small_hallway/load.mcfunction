execute if entity @a[advancements={luigis_mansion:money={small_hallway_money=false}},limit=1] run function luigis_mansion:room/small_hallway/money
...
execute if entity @a[advancements={luigis_mansion:mansion/small_hallway=false},limit=1] run function luigis_mansion:room/small_hallway/ghosts
