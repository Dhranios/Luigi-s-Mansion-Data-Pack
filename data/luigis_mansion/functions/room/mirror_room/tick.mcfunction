...
execute if score #mirror_room Wave matches 4 unless entity @e[tag=ghost,scores={Room=17},tag=!optional_ghost] run function luigis_mansion:room/mirror_room/clear
execute if score #mirror_room Wave matches 3 unless entity @e[tag=ghost,scores={Room=17},tag=!optional_ghost] run function luigis_mansion:room/mirror_room/wave_4
execute if score #mirror_room Wave matches 2 unless entity @e[tag=ghost,scores={Room=17},tag=!optional_ghost] run function luigis_mansion:room/mirror_room/wave_3
execute if score #mirror_room Wave matches 1 unless entity @e[tag=ghost,scores={Room=17},tag=!optional_ghost] run function luigis_mansion:room/mirror_room/wave_2
...
function #luigis_mansion:room/interactions/mirror_room
