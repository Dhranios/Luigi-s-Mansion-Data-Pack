...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 713 103 -42 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 713.0 102 -42 run function luigis_mansion:blocks/dust
...
tag @e[x=713.5,y=102,z=-41.5,distance=..0.7,tag=ghost_marker] add spawn