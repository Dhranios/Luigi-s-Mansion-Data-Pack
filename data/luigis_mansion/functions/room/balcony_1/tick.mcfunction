...
execute if entity @e[x=673.5,y=112,z=44.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=water,limit=1] run function luigis_mansion:room/balcony_1/water_plant_1
execute if entity @e[x=672.5,y=112,z=44.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=water,limit=1] run function luigis_mansion:room/balcony_1/water_plant_2
execute if entity @e[x=674.5,y=112,z=43.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=water,limit=1] run function luigis_mansion:room/balcony_1/water_plant_3
execute if entity @e[x=674.5,y=112,z=41.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=water,limit=1] run function luigis_mansion:room/balcony_1/water_plant_4
