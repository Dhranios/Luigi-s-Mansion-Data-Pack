...
execute if score #graveyard_tree_trunk Searched matches 1 if entity @s[x=668.5,y=102,z=56.5,distance=..0.7] run function luigis_mansion:room/graveyard/go_through_tree_trunk