...
tag @e[tag=ghost,x=683,y=122,z=-18,dx=38,dy=6,dz=11] add hallway
...
function luigis_mansion:room/door/safari_room_attic_hallway_1
function luigis_mansion:room/door/attic_hallway_1_balcony_2
