...
execute if score #hidden_room_hole Searched matches 1 if entity @s[x=710.5,y=102,z=35.5,distance=..0.7] run function luigis_mansion:room/hidden_room/go_through_hole