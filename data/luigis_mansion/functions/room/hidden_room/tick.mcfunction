...
execute if score #hidden_room Wave matches 1 unless entity @e[tag=ghost,scores={Room=20},tag=!optional_ghost] run function luigis_mansion:room/hidden_room/clear
...
function #luigis_mansion:room/interactions/hidden_room
