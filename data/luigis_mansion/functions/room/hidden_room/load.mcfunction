execute if entity @a[advancements={luigis_mansion:mansion/hidden_room=true},tag=!blackout,limit=1] run function luigis_mansion:room/hidden_room/turn_on_lights
