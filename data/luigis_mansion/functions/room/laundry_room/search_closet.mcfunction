...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=money] unless score #laundry_room_closet Searched matches 1 run function luigis_mansion:room/laundry_room/closet
