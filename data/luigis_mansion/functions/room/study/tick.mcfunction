...
execute if score #study Wave matches 1 unless entity @e[tag=ghost,scores={Room=7},tag=!optional_ghost] run function luigis_mansion:room/study/clear
...
function #luigis_mansion:room/interactions/study
