...
execute if score #storage_room Wave matches 3 unless entity @e[tag=ghost,scores={Room=14},tag=!optional_ghost] run function luigis_mansion:room/storage_room/clear
execute if score #storage_room Wave matches 2 unless entity @e[tag=ghost,scores={Room=14},tag=!optional_ghost] run function luigis_mansion:room/storage_room/wave_3
execute if score #storage_room Wave matches 1 unless entity @e[tag=ghost,scores={Room=14},tag=!optional_ghost] run function luigis_mansion:room/storage_room/wave_2
...
function #luigis_mansion:room/interactions/storage_room
