execute if entity @a[advancements={luigis_mansion:mansion/attic_hallway_2=true},tag=!blackout,limit=1] run function luigis_mansion:room/attic_hallway_2/turn_on_lights
