...
stopsound @a[advancements={luigis_mansion:mansion/artist_studio=false}] music
playsound luigis_mansion:music.cleared_room music @a[advancements={luigis_mansion:mansion/artist_studio=false}] ~ ~ ~ 10000
