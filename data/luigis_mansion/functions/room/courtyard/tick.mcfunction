...
execute if score #courtyard Wave matches 2 unless entity @e[tag=ghost,scores={Room=26},tag=!optional_ghost] run function luigis_mansion:room/courtyard/clear
execute if score #courtyard Wave matches 1 unless entity @e[tag=ghost,scores={Room=26},tag=!optional_ghost] run function luigis_mansion:room/courtyard/wave_2
execute if entity @a[advancements={luigis_mansion:mansion/courtyard=false}] unless score #courtyard Wave matches 1.. run function luigis_mansion:room/courtyard/wave_1

function #luigis_mansion:room/interactions/courtyard
