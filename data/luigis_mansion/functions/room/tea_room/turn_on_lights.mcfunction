...
scoreboard players set @a[advancements={luigis_mansion:mansion/tea_room=false}] MusicType 9
advancement grant @a only luigis_mansion:mansion/tea_room
execute if entity @a[advancements={luigis_mansion:technical={released_boos_talk=true}},scores={Boos=..49},limit=1] run function luigis_mansion:room/tea_room/load_boos
