...
scoreboard players set @a[x=788,y=90,z=21,dx=1,dy=1,dz=0] Room 0
execute as @a[x=788,y=90,z=21,dx=1,dy=1,dz=0] unless entity @s[scores={MusicType=0}] run function luigis_mansion:other/music/set/silence
