...
execute as @e[x=698,y=112,z=-44,dx=8,dy=16,dz=26] unless entity @s[scores={Room=1..}] run scoreboard players set @s Room 31
execute as @e[x=698,y=112,z=-25,dx=8,dy=6,dz=22] unless entity @s[scores={Room=1..}] run scoreboard players set @s Room 31
execute as @e[x=664,y=112,z=-11,dx=42,dy=6,dz=8] unless entity @s[scores={Room=1..}] run scoreboard players set @s Room 31
execute as @e[x=664,y=112,z=-18,dx=8,dy=6,dz=43] unless entity @s[scores={Room=1..}] run scoreboard players set @s Room 31
execute as @e[x=653,y=112,z=17,dx=19,dy=6,dz=8] unless entity @s[scores={Room=1..}] run scoreboard players set @s Room 31
