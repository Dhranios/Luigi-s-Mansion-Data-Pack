execute if entity @a[advancements={luigis_mansion:money={nursery_lamp=false}},limit=1] positioned 713 116 50 run function luigis_mansion:spawn_entities/item/gold_coin
execute if entity @a[advancements={luigis_mansion:money={nursery_lamp=false}},limit=1] positioned 713 116 48 run function luigis_mansion:spawn_entities/item/gold_coin
...
execute if entity @a[advancements={luigis_mansion:money={nursery_lamp=true}},limit=1] run tag @e[tag=selected] add nothing
