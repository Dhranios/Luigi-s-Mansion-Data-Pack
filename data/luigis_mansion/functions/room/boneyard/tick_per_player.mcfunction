...
execute if score #boneyard_dog_house Searched matches 1 if entity @s[x=674.5,y=102,z=56.5,distance=..0.7] run function luigis_mansion:room/boneyard/go_through_dog_house