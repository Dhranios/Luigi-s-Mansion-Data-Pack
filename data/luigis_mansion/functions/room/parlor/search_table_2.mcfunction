...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/parlor/table_2
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 686 112 8.0 run function luigis_mansion:blocks/dust
...
tag @e[x=686.5,y=112,z=7.5,distance=..0.7,tag=ghost_marker] add spawn