execute if entity @a[advancements={luigis_mansion:technical={found_e_gadd=true},luigis_mansion:money={parlor_money=false}},limit=1] run function luigis_mansion:room/parlor/money
