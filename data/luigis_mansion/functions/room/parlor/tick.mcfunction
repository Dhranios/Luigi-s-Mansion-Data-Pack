...
execute if block 690 112 2 minecraft:white_wool if entity @e[x=690.0,y=112,z=2.0,dx=3,dy=0,dz=2,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_table
