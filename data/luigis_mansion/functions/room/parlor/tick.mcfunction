...
execute as @e[tag=eternal_coin,scores={Room=2}] run scoreboard players add #temp Wave 1
...
execute unless block 696 113 -1 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/parlor/search_table_2
execute unless block 686 112 8 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/parlor/search_table_1
execute unless block 686 112 7 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/parlor/search_table_1
...
execute if entity @e[x=697.5,y=114,z=2.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_painting_3
execute if entity @e[x=693.0,y=113,z=-2.0,dx=1,dy=1,dz=0,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_painting_7
execute if entity @e[x=688.0,y=113,z=-2.0,dx=1,dy=1,dz=0,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_painting_6
execute if entity @e[x=693.0,y=113,z=17.0,dx=1,dy=1,dz=0,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_painting_2
execute if entity @e[x=688.0,y=113,z=17.0,dx=1,dy=1,dz=0,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_painting_1
execute if entity @e[x=697.5,y=114,z=13.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_painting_5
execute if entity @e[x=691.0,y=112,z=12.0,dx=1,dy=1,dz=1,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_table_1
execute if entity @e[x=690.5,y=112,z=12.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_chair
execute if entity @e[x=690.0,y=112,z=-1.0,dx=3,dy=0,dz=0,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_couch
execute if entity @e[x=686.0,y=113,z=6.0,dx=0,dy=1,dz=0,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_candle_1
execute if entity @e[x=686.0,y=113,z=9.0,dx=0,dy=1,dz=0,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_candle_2
execute if entity @e[x=685.0,y=113,z=7.0,dx=0,dy=1,dz=1,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_painting_4
execute if entity @e[x=691.5,y=113,z=3.5,distance=..0.7,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_candle_3

execute if entity @e[x=690.0,y=112,z=2.0,dx=3,dy=0,dz=2,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_table_2
execute if entity @e[x=692.0,y=118,z=8.0,distance=..1.5,type=minecraft:area_effect_cloud,tag=vacuum,limit=1] run function luigis_mansion:room/parlor/vacuum_lamp
