...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 667 105 27.0 run function luigis_mansion:spawn_entities/item/small_heart
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 666 105 27.0 run function luigis_mansion:blocks/dust
...
tag @e[x=666.5,y=105,z=27.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=666.5,y=105,z=27.5,distance=..0.7,tag=ghost_marker] add spawn