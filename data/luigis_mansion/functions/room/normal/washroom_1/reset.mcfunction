...
setblock 668 106 31 minecraft:air
data merge block 666 105 26 {Items:[]}
data merge block 666 105 27 {Items:[]}
data merge block 667 102 30 {Items:[]}
data merge block 668 102 34 {Items:[]}
setblock 668 103 34 minecraft:oak_trapdoor[facing=north,half=bottom,open=false]
setblock 667 105 26 minecraft:oak_trapdoor[facing=east,half=top,open=true]
