...
execute if entity @a[advancements={luigis_mansion:mansion/nanas_room=false}] unless score #nanas_room Wave matches -1.. run function luigis_mansion:room/normal/nanas_room/wave_1
