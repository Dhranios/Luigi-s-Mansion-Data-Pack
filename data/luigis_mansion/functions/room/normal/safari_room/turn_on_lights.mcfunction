setblock 712 124 -22 minecraft:stone_button[face=ceiling,powered=true]
setblock 712 124 -30 minecraft:stone_button[face=ceiling,powered=true]
setblock 711 120 -23 minecraft:trapped_chest[facing=east,type=single]{LootTable:"luigis_mansion:search"}
