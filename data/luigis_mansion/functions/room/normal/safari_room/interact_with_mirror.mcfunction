execute if entity @s[x=717.0,y=123,z=-30.0,dx=0,dy=3,dz=3,tag=vacuum] unless score #safari_room_mirror Search matches 1 run scoreboard players add #safari_room_mirror Searching 1
execute if entity @s[x=717.0,y=123,z=-30.0,dx=0,dy=3,dz=3,tag=vacuum] run scoreboard players set #safari_room_mirror Search 1
