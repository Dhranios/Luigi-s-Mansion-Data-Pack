...
execute if entity @a[advancements={luigis_mansion:mansion/safari_room=false},tag=!blackout] unless score #safari_room Wave matches 1.. run function luigis_mansion:room/normal/safari_room/wave_1
