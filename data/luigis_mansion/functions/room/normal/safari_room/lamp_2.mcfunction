execute if entity @a[advancements={luigis_mansion:mansion/safari_room_lamp_2=false},limit=1] positioned 713 126 -32 run function luigis_mansion:spawn_entities/item/gold_bar
