execute if entity @a[advancements={luigis_mansion:mansion/safari_room_lamp_2=false},limit=1] positioned 712 124 -30 run function luigis_mansion:spawn_entities/item/gold_bar
