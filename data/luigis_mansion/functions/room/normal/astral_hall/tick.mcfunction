...
execute as @a[x=677,y=112,z=-32,dx=0,dy=1,dz=0,advancements={luigis_mansion:mansion/astral_hall=false}] at @s run function luigis_mansion:room/normal/astral_hall/trick_door
