...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 674 112 -15 run function luigis_mansion:blocks/dust
scoreboard players set #astral_hall_table_1 Searched 1
data merge block 674 112 -15 {LootTable:"luigis_mansion:search"}
tag @e[x=674.5,y=112,z=-14.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=674.5,y=112,z=-14.5,distance=..0.7,tag=ghost_marker] add spawn