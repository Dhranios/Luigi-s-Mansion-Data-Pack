...
execute if entity @a[advancements={luigis_mansion:mansion/billiards_room=false}] unless score #billiards_room Wave matches 1.. run function luigis_mansion:room/normal/billiards_room/wave_1
