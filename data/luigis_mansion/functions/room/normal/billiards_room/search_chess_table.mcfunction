...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 681 103 16 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 681 102 16 run function luigis_mansion:blocks/dust
scoreboard players set #billiards_room_chess_table Searched 1
tag @e[x=681.5,y=102,z=16.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=681.5,y=102,z=16.5,distance=..0.7,tag=ghost_marker] add spawn