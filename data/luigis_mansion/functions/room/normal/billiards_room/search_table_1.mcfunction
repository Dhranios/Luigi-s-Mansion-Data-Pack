...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=poison_mushroom] positioned 677 103 38 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 677 102 38 run function luigis_mansion:blocks/dust
scoreboard players set #billiards_room_table_1 Searched 1
data merge block 677 102 38 {LootTable:"luigis_mansion:search"}
tag @e[x=677.5,y=102,z=38.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=677.5,y=102,z=38.5,distance=..0.7,tag=ghost_marker] add spawn