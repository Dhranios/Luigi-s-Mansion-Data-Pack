...
execute if entity @a[x=717.5,y=105,z=-39.5,distance=..5] if entity @a[nbt={Inventory:[{tag:{luigis_mansion:{id:"luigis_mansion:fire_element_medal"}}}]}] unless entity @e[x=717.5,y=105,z=-39.5,distance=..5,tag=fire_elemental_ghost] positioned 717 105.5 -40 run function luigis_mansion:spawn_entities/ghost/fire_elemental_ghost
