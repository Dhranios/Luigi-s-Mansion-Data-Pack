execute if entity @a[advancements={luigis_mansion:mansion/hallway_jar_6=false},limit=1] positioned 700 114.5 -27 run function luigis_mansion:spawn_entities/item/gold_bar
