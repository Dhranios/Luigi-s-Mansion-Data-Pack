...
execute if entity @a[advancements={luigis_mansion:mansion/hallway=false}] unless score #hallway Wave matches 1.. run function luigis_mansion:room/normal/hallway/wave_1
...
execute if entity @a[x=666.5,y=114,z=7.5,distance=..5] if entity @a[nbt={Inventory:[{tag:{luigis_mansion:{id:"luigis_mansion:fire_element_medal"}}}]}] unless entity @e[x=666.5,y=114,z=7.5,distance=..5,tag=fire_elemental_ghost] positioned 666 114 7 run function luigis_mansion:spawn_entities/ghost/fire_elemental_ghost
execute if entity @a[x=700.5,y=114,z=-22.5,distance=..5] if entity @a[nbt={Inventory:[{tag:{luigis_mansion:{id:"luigis_mansion:fire_element_medal"}}}]}] unless entity @e[x=700.5,y=114,z=-22.5,distance=..5,tag=fire_elemental_ghost] positioned 700 114 -23 run function luigis_mansion:spawn_entities/ghost/fire_elemental_ghost
