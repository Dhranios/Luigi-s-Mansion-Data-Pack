execute if entity @a[advancements={luigis_mansion:mansion/hallway_jar_3=false},limit=1] positioned 666 113.5 -6 run function luigis_mansion:spawn_entities/item/gold_bar
