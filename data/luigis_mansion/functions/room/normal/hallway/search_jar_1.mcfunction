...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=poison_mushroom] positioned 666 114.5 13 run function luigis_mansion:spawn_entities/item/poison_mushroom
