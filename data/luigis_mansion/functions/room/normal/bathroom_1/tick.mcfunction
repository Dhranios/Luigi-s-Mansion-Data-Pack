...
execute if entity @a[advancements={luigis_mansion:mansion/bathroom_1=false}] unless score #bathroom_1 Wave matches 1.. run function luigis_mansion:room/normal/bathroom_1/wave_1
