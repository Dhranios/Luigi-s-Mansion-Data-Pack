...
execute if entity @a[x=656.5,y=106.0,z=34.5,distance=..5] if entity @a[nbt={Inventory:[{tag:{luigis_mansion:{id:"luigis_mansion:water_element_medal"}}}]}] unless entity @e[x=656.5,y=106.0,z=34.5,distance=..5,tag=water_elemental_ghost] positioned 656 106.0 34 run function luigis_mansion:spawn_entities/ghost/water_elemental_ghost
