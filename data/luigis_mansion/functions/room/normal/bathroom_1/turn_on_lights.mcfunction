execute unless entity @e[type=minecraft:armor_stand,tag=key,tag=ball_room,limit=1] unless data storage luigis_mansion:data current_state.current_data.obtained_keys{ball_room:1b} run summon minecraft:armor_stand 662 107 36 {Pose:{Head:[0.0f,0.0f,0.01f]},Marker:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:5,CustomModelData:15}}],Small:1b,Tags:["item","key","ball_room"],DisabledSlots:2039583}
