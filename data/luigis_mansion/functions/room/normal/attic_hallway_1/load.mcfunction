...
execute if entity @a[advancements={luigis_mansion:mansion/artists_studio_key=false},limit=1] run function luigis_mansion:room/normal/artists_studio/lock_door
