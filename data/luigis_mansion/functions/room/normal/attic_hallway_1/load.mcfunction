...
execute if entity @a[advancements={luigis_mansion:keys={balcony_2=false}},limit=1] run function luigis_mansion:room/normal/balcony_2/lock_door
execute if entity @a[advancements={luigis_mansion:keys={artist_studio=false}},limit=1] run function luigis_mansion:room/normal/artist_studio/lock_door
