...
execute unless data storage luigis_mansion:data current_state.current_data.room.armory{cleared:1b} if entity @a[tag=!blackout] unless score #armory Wave matches 1.. run function luigis_mansion:room/normal/armory/wave_1
