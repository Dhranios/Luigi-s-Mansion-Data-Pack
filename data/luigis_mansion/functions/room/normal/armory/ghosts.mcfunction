...
execute if entity @a[advancements={luigis_mansion:mansion/armory=false},tag=!blackout] unless score #armory Wave matches 1.. run function luigis_mansion:room/normal/armory/wave_1
