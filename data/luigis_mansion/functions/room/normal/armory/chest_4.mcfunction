execute if entity @a[advancements={luigis_mansion:mansion/armory_chest_4=false},limit=1] positioned 700 121 44.0 run function luigis_mansion:spawn_entities/item/gold_bar
