...
setblock 679 106 2 minecraft:air
setblock 679 106 8 minecraft:air
setblock 679 102 9 minecraft:air
setblock 684 103 5 minecraft:air
setblock 682 102 0 minecraft:oak_trapdoor[facing=south,half=bottom,open=true]
setblock 681 102 0 minecraft:oak_trapdoor[facing=south,half=bottom,open=true]
data merge block 682 102 -1 {Items:[]}
data merge block 681 102 -1 {Items:[]}
tag @e[x=673.0,y=103,z=1.0,dx=1,dy=3,dz=8,type=minecraft:item_frame] add dead
