...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=poison_mushroom] positioned 680.0 102 0 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 680.0 102 -1 run function luigis_mansion:blocks/dust
...
tag @e[x=680.5,y=102,z=-0.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=680.5,y=102,z=-0.5,distance=..0.7,tag=ghost_marker] add spawn
teleport @e[x=680.5,y=102,z=-0.5,distance=..0.7,tag=spawn] 680.0 102 -1