...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=poison_mushroom] positioned 688 103 3 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 687 103 3 run function luigis_mansion:blocks/dust
...
tag @e[x=687.5,y=102,z=3.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=687.5,y=102,z=3.5,distance=..0.7,tag=ghost_marker] add spawn