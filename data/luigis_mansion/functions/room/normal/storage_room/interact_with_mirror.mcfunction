execute if entity @s[x=673.0,y=102,z=-33.0,dx=0,dy=3,dz=2,tag=vacuum] unless score #storage_room_mirror Search matches 1 run scoreboard players add #storage_room_mirror Searching 1
execute if entity @s[x=673.0,y=102,z=-33.0,dx=0,dy=3,dz=2,tag=vacuum] run scoreboard players set #storage_room_mirror Search 1
