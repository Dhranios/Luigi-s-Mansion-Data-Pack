...
execute if block 673 104 -18 minecraft:stone_button[powered=true] if block 677 101 -18 minecraft:oak_slab unless entity @a[tag=release_boos,limit=1] unless entity @a[x=676.0,y=102,z=-19.0,dx=2,dy=6,dz=2,limit=1] positioned 673 104 -18 run tag @p[gamemode=!spectator] add release_boos
