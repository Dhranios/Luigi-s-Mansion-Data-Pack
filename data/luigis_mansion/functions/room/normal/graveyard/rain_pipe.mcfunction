execute if entity @a[advancements={luigis_mansion:mansion/graveyard_rain_pipe=false},limit=1] positioned 669 103 43 run function luigis_mansion:spawn_entities/item/red_ruby
