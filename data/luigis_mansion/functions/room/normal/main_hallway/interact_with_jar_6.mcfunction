execute if entity @s[x=700.5,y=103,z=-14.5,distance=..1.5,tag=vacuum] unless score #main_hallway_jar_6 Search matches 1 run scoreboard players add #main_hallway_jar_6 Searching 1
execute if entity @s[x=700.5,y=103,z=-14.5,distance=..1.5,tag=vacuum] run scoreboard players set #main_hallway_jar_6 Search 1
