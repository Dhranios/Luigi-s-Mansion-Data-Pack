execute if entity @a[advancements={luigis_mansion:mansion/main_hallway_jar_1=false},limit=1] positioned 700 104.5 32 run function luigis_mansion:spawn_entities/item/gold_bar
