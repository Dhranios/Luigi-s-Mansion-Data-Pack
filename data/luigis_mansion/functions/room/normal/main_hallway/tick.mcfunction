...
execute as @a[x=698,y=102,z=-22,dx=8,dy=6,dz=60] unless entity @s[scores={Room=10}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=698,y=102,z=-22,dx=8,dy=6,dz=60] run scoreboard players set @s Room 10
execute as @a[x=664,y=102,z=-10,dx=42,dy=6,dz=8] unless entity @s[scores={Room=10}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=664,y=102,z=-10,dx=42,dy=6,dz=8] run scoreboard players set @s Room 10
execute as @a[x=664,y=102,z=-17,dx=8,dy=6,dz=42] unless entity @s[scores={Room=10}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=664,y=102,z=-17,dx=8,dy=6,dz=42] run scoreboard players set @s Room 10
execute as @a[x=653,y=102,z=17,dx=19,dy=6,dz=8] unless entity @s[scores={Room=10}] run scoreboard players operation @s LastRoom = @s Room
...
execute as @a[gamemode=!spectator,x=700,y=102,z=-20,dx=4,dy=6,dz=56] run function luigis_mansion:room/normal/main_hallway/tick_per_player
execute as @a[gamemode=!spectator,x=666,y=102,z=-8,dx=38,dy=6,dz=4] unless entity @s[x=700,y=102,z=-20,dx=4,dy=6,dz=56] run function luigis_mansion:room/normal/main_hallway/tick_per_player
