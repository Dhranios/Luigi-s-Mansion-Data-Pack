execute if entity @a[advancements={luigis_mansion:mansion/main_hallway_jar_5=false},limit=1] positioned 666 104.5 -13 run function luigis_mansion:spawn_entities/item/gold_bar
