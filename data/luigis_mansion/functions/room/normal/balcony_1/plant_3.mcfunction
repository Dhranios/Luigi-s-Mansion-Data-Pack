execute if entity @a[advancements={luigis_mansion:mansion/balcony_1_plant_3=false},limit=1] positioned 674 112 41 run function luigis_mansion:spawn_entities/item/blue_sapphire
