execute if entity @a[tag=!blackout,limit=1] positioned 677 112 44 unless entity @e[distance=..0.7,tag=toad,limit=1] run function luigis_mansion:spawn_entities/toad/balcony_1
