execute if entity @a[x=659.5,y=103,z=-11.5,distance=..0.7,gamemode=!spectator,limit=1] unless score #rec_room_threadmill Search matches 1 store result score #rec_room_threadmill Search run scoreboard players add #rec_room_threadmill Searching 1
