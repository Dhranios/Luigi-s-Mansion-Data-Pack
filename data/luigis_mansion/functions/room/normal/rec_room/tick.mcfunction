...
execute if entity @a[advancements={luigis_mansion:mansion/rec_room=false}] unless score #rec_room Wave matches 1.. run function luigis_mansion:room/normal/rec_room/wave_1
