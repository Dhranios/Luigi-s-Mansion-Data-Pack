...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 659 106 -18 run function luigis_mansion:spawn_entities/item/small_heart
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 659 107 -18 run function luigis_mansion:blocks/dust
