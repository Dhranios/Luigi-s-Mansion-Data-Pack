...
execute if entity @a[tag=looking_at_map,limit=1] run function luigis_mansion:items/gameboy_horror/map/normal/rec_room
playsound luigis_mansion:block.chest.spawn block @a 660 102 -34 2
