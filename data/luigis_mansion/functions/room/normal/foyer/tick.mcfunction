...
execute unless entity @e[type=minecraft:item,nbt={Item:{tag:{luigis_mansion:{id:"luigis_mansion:key",room:"parlor"}}}},limit=1] unless entity @a[nbt={Inventory:[{tag:{luigis_mansion:{id:"luigis_mansion:key",room:"parlor"}}}]},limit=1] unless data storage luigis_mansion:data current_state.current_data.used_keys{parlor:1b} if entity @e[x=699,y=112,z=7,dx=0,dy=1,dz=1,tag=door,nbt={Age:60}] positioned 714.0 104 8.0 run playsound luigis_mansion:entity.ghost.cry hostile @a ~ ~ ~ 3
execute unless entity @e[type=minecraft:item,nbt={Item:{tag:{luigis_mansion:{id:"luigis_mansion:key",room:"parlor"}}}},limit=1] unless entity @e[type=minecraft:armor_stand,tag=first_key,limit=1] unless entity @a[nbt={Inventory:[{tag:{luigis_mansion:{id:"luigis_mansion:key",room:"parlor"}}}]},limit=1] unless data storage luigis_mansion:data current_state.current_data.used_keys{parlor:1b} if entity @e[x=699,y=111,z=7,dx=0,dy=1,dz=1,tag=door] run summon minecraft:armor_stand 714.0 104 8.0 {Tags:["first_key"],NoGravity:1b,Invulnerable:1b,Silent:1b,Invisible:1b,DisabledSlots:2039583,ArmorItems:[{},{},{},{id:"minecraft:brick",Count:1b,tag:{CustomModelData:1}}]}
