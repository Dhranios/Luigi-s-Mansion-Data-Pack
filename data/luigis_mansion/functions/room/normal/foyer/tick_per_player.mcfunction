...
execute if entity @s[x=702.5,y=111,z=14.5,distance=..3,advancements={luigis_mansion:mansion/wardrobe_room=true,luigis_mansion:technical={portrait_ghosts=false}}] run scoreboard players set @a GBHCall 1