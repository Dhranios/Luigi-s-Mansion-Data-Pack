...
execute as @a[gamemode=!spectator,x=648.5,y=92,z=-11.5,distance=..0.7,advancements={luigis_mansion:technical={saw_mario=true,saw_mario_again=false}}] unless entity @a[tag=marios_painting_repeat] run tag @s add marios_painting_repeat