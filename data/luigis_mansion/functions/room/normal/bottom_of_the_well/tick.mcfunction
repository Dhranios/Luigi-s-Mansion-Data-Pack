...
execute as @a[gamemode=!spectator,x=647,y=92,z=-12,dx=2,dy=6,dz=8] run function luigis_mansion:room/normal/bottom_of_the_well/tick_per_player
...
execute if entity @a[advancements={luigis_mansion:mansion/bottom_of_the_well=false,luigis_mansion:technical={saw_mario=true}}] unless score #bottom_of_the_well Wave matches 1.. run function luigis_mansion:room/normal/bottom_of_the_well/wave_1
