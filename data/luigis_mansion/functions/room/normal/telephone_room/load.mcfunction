...
execute if entity @a[advancements={luigis_mansion:mansion/clockwork_room_key=false},limit=1] run function luigis_mansion:room/normal/clockwork_room/lock_door
