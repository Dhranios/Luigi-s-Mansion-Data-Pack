...
execute if entity @a[advancements={luigis_mansion:technical={observatory_destroyed=true}},limit=1] run setblock 673 110 -41 minecraft:stone_button[face=wall,facing=north,powered=true]
