execute if entity @a[advancements={luigis_mansion:mansion/observatory_table=false},limit=1] positioned 673 112 -33.0 run function luigis_mansion:spawn_entities/item/gold_bar
