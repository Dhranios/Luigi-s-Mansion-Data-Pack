...
fill 667 108 -102 682 112 -45 minecraft:air
fill 668 113 -56 669 114 -55 minecraft:air
setblock 672 110 -46 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_mansion:observatory/normal"}
