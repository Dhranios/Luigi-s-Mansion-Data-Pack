...
execute if entity @a[x=681.5,y=102,z=40.5,distance=..5] if entity @a[nbt={Inventory:[{tag:{luigis_mansion:{id:"luigis_mansion:water_element_medal"}}}]}] unless entity @e[x=681.5,y=102,z=40.5,distance=..5,tag=water_elemental_ghost] positioned 681 102 40 run function luigis_mansion:spawn_entities/ghost/water_elemental_ghost