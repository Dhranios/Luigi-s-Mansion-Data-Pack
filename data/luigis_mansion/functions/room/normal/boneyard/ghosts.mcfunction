...
execute unless data storage luigis_mansion:data current_state.current_data.room.boneyard{cleared:1b} if entity @a[tag=!blackout] unless score #boneyard Wave matches 1.. run function luigis_mansion:room/normal/boneyard/wave_1
