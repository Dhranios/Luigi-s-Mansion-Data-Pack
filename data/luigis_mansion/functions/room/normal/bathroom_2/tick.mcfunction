...
execute if entity @a[advancements={luigis_mansion:mansion/bathroom_2=false}] unless score #bathroom_2 Wave matches 1.. run function luigis_mansion:room/normal/bathroom_2/wave_1
