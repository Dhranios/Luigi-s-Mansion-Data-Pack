...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 668 114 -38 run function luigis_mansion:spawn_entities/item/small_heart
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 668 115 -38 run function luigis_mansion:blocks/dust
