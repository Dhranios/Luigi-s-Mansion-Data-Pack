...
execute if entity @a[advancements={luigis_mansion:mansion/main_stairs=false}] unless score #main_stairs Wave matches 1.. run function luigis_mansion:room/normal/main_stairs/wave_1
