...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 700 102 48 run function luigis_mansion:blocks/dust
scoreboard players set #laundry_room_closet Searched 1
data merge block 700 102 48 {LootTable:"luigis_mansion:search"}
tag @e[x=700.5,y=102,z=48.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=700.5,y=102,z=48.5,distance=..0.7,tag=ghost_marker] add spawn