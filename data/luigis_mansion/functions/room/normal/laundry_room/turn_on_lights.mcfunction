setblock 702 106 47 minecraft:stone_button[face=ceiling,powered=true]
setblock 702 102 46 minecraft:trapped_chest[facing=east,type=single]{LootTable:"luigis_mansion:search"}
