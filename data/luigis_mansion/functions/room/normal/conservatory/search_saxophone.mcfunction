...
execute positioned 659 103 15 run function luigis_mansion:blocks/dust
scoreboard players set #conservatory_saxophone Searched 1
tag @e[x=659.5,y=102,z=15.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=659.5,y=102,z=15.5,distance=..0.7,tag=ghost_marker] add spawn