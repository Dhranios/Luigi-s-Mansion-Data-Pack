setblock 659 106 3 minecraft:stone_button[face=ceiling,powered=true]
setblock 659 102 2 minecraft:trapped_chest[facing=east,type=single]{LootTable:"luigis_mansion:search"}
