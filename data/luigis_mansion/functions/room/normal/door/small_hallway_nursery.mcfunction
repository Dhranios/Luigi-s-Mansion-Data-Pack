...
execute if block 705 111 42 #minecraft:doors[open=true] if entity @a[advancements={luigis_mansion:mansion/nursery_key=false},limit=1] positioned 705 111 42 run function luigis_mansion:blocks/closed_door
