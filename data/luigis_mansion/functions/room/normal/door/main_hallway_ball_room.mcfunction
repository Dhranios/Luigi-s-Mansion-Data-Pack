...
execute if block 692 102 -9 #minecraft:doors[open=true] if entity @a[advancements={luigis_mansion:mansion/ball_room_key=false},limit=1] positioned 692 102 -9 run function luigis_mansion:blocks/closed_door
