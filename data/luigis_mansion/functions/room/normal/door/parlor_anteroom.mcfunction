...
execute if entity @a[gamemode=!spectator,distance=..6,x=684.5,y=112,z=1.5] if score #temp Searched matches 1 run scoreboard players set #temp Searched 2
execute unless entity @a[gamemode=!spectator,distance=..6,x=684.5,y=112,z=1.5] if score #temp Searched matches 1 run scoreboard players set #temp Searched 0
