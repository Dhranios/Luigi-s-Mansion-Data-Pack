...
execute if score #temp Searched matches 0 run playsound minecraft:block.wooden_door.close block @a 698 122 37 1 1
execute if score #temp Searched matches 0 run setblock 699 122 37 minecraft:oak_door[open=false,facing=west,half=lower,hinge=right,powered=false]
execute if score #temp Searched matches 0 run setblock 697 122 37 minecraft:oak_door[open=false,facing=east,half=lower,hinge=left,powered=false]
