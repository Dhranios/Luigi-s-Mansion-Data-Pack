...
execute if block 668 102 24 #minecraft:doors[open=true] unless score #temp Boos matches 5.. positioned 668 102 24 as @p[gamemode=!spectator] unless entity @s[scores={GBHCall=1..}] unless entity @s[scores={Dialog=1..}] run tag @s add washroom_toad
execute if block 668 102 24 #minecraft:doors[open=true] unless score #temp Boos matches 5.. positioned 668 102 24 run function luigis_mansion:blocks/closed_door
