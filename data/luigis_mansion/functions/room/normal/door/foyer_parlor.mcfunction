...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=699.0,y=111,z=8.0,nbt={SelectedItem:{tag:{luigis_mansion:{id:"luigis_mansion:key",room:"parlor"}}}}] run function luigis_mansion:room/normal/parlor/unlock_door
execute if block 699 111 7 #minecraft:doors[open=true] if entity @a[advancements={luigis_mansion:mansion/parlor_key=false},limit=1] positioned 699 111 7 run function luigis_mansion:blocks/closed_door
execute if block 699 111 8 #minecraft:doors[open=true] if entity @a[advancements={luigis_mansion:mansion/parlor_key=false},limit=1] positioned 699 111 8 run function luigis_mansion:blocks/closed_door
execute if entity @a[advancements={luigis_mansion:mansion/parlor_key=false},limit=1] if score #temp Searched matches 1..2 run scoreboard players set #temp Searched -1
