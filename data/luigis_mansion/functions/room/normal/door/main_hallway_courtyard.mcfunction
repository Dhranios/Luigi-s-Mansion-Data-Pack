...
execute if block 654 102 21 #minecraft:doors[open=true] if entity @a[advancements={luigis_mansion:mansion/courtyard_key=false},limit=1] positioned 654 102 21 run function luigis_mansion:blocks/closed_door
