...
execute if score #temp Searched matches 1 run fill 705 102 7 706 103 8 minecraft:air replace #minecraft:doors
...
execute if score #temp Searched matches -1..0 run fill 705 102 7 706 103 8 minecraft:air replace #minecraft:doors
