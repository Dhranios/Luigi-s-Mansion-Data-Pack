execute if block 707 102 7 minecraft:jungle_door[open=true] if block 707 102 8 minecraft:jungle_door[open=false] run scoreboard players set #temp Searched 1
execute if block 707 102 8 minecraft:jungle_door[open=true] if block 707 102 7 minecraft:jungle_door[open=false] run scoreboard players set #temp Searched 1
execute if block 707 102 7 minecraft:jungle_door[open=true] if block 707 102 8 minecraft:jungle_door[open=true] unless score #temp Searched matches 1 run scoreboard players set #temp Searched 2
execute if block 707 102 8 minecraft:jungle_door[open=true] if block 707 102 7 minecraft:jungle_door[open=true] unless score #temp Searched matches 1 run scoreboard players set #temp Searched 2
...
execute if block 706 103 8 minecraft:barrier if score #temp Searched matches 1..2 run scoreboard players set #temp Searched -1
execute unless entity @a[gamemode=!spectator,distance=..3,x=706.5,y=102,z=8.0] if score #temp Searched matches 1..2 run scoreboard players set #temp Searched 0

execute if score #temp Searched matches 1 run fill 705 102 7 707 103 8 minecraft:air replace #minecraft:doors
execute if score #temp Searched matches 1 run setblock 707 102 7 minecraft:jungle_door[open=true,facing=west,half=lower,hinge=right,powered=true]
execute if score #temp Searched matches 1 run setblock 707 103 7 minecraft:jungle_door[open=true,facing=west,half=upper,hinge=right,powered=true]
execute if score #temp Searched matches 1 run setblock 707 102 8 minecraft:jungle_door[open=true,facing=west,half=lower,hinge=left,powered=true]
execute if score #temp Searched matches 1 run setblock 707 103 8 minecraft:jungle_door[open=true,facing=west,half=upper,hinge=left,powered=true]
...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a 706 102 8.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a 706 102 8.0 1 1
execute if score #temp Searched matches -1..0 run fill 705 102 7 707 103 8 minecraft:air replace #minecraft:doors
...
execute if score #temp Searched matches -1..0 run setblock 707 103 7 minecraft:jungle_door[open=false,facing=west,half=upper,hinge=right,powered=true]
...
execute if score #temp Searched matches -1..0 run setblock 707 103 8 minecraft:jungle_door[open=false,facing=west,half=upper,hinge=left,powered=true]
