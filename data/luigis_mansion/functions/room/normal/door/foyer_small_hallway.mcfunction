...
execute if block 702 111 17 #minecraft:doors[open=true] if entity @a[advancements={luigis_mansion:mansion/small_hallway_key=false},limit=1] positioned 702 111 17 run function luigis_mansion:blocks/closed_door
