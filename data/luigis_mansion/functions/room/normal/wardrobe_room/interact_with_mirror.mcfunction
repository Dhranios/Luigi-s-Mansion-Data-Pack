execute if entity @s[x=673.0,y=111,z=22.0,dx=0,dy=4,dz=3,tag=vacuum] unless score #wardrobe_room_mirror Search matches 1 run scoreboard players add #wardrobe_room_mirror Searching 1
execute if entity @s[x=673.0,y=111,z=22.0,dx=0,dy=4,dz=3,tag=vacuum] run scoreboard players set #wardrobe_room_mirror Search 1
