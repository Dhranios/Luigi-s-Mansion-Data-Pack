...
execute as @a[gamemode=!spectator,x=674,y=112,z=20,dx=8,dy=6,dz=17] run function luigis_mansion:room/normal/wardrobe_room/tick_per_player
...
execute if entity @a[advancements={luigis_mansion:mansion/wardrobe_room=false}] unless score #wardrobe_room Wave matches 1.. run function luigis_mansion:room/normal/wardrobe_room/wave_1
