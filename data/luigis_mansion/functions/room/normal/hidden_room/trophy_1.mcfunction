execute if entity @a[advancements={luigis_mansion:mansion/hidden_room_trophy_1=false},limit=1] positioned 715 104 34 run function luigis_mansion:spawn_entities/item/gold_bar
