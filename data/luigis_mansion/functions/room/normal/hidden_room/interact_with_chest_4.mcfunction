execute if entity @s[x=708.0,y=102,z=28.0,dx=0,dy=0,dz=1,tag=vacuum] unless score #hidden_room_chest_4 Search matches 1 run scoreboard players add #hidden_room_chest_4 Searching 1
execute if entity @s[x=708.0,y=102,z=28.0,dx=0,dy=0,dz=1,tag=vacuum] run scoreboard players set #hidden_room_chest_4 Search 1
