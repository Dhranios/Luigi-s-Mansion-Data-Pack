...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=poison_mushroom] positioned 715 104 34 run function luigis_mansion:spawn_entities/item/poison_mushroom
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 715 104 34 run function luigis_mansion:spawn_entities/item/small_heart
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 715 104 35 run function luigis_mansion:blocks/dust
scoreboard players set #hidden_room_trophy_1 Searched 1
tag @e[x=715.5,y=104,z=35.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=715.5,y=104,z=35.5,distance=..0.7,tag=ghost_marker] add spawn