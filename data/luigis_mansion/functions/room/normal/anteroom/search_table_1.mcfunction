...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=poison_mushroom] positioned 673 113 16.0 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=673.5,y=112,z=15.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=673.5,y=112,z=15.5,distance=..0.7,tag=ghost_marker] add spawn