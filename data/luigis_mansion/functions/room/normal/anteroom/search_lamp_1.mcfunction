...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=poison_mushroom] positioned 677 114 11 run function luigis_mansion:spawn_entities/item/poison_mushroom
