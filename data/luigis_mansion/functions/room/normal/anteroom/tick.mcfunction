...
execute as @a[gamemode=!spectator,x=674,y=112,z=-1,dx=8,dy=6,dz=17] run function luigis_mansion:room/normal/anteroom/tick_per_player
...
execute if entity @a[advancements={luigis_mansion:mansion/anteroom=false},tag=!blackout] unless score #anteroom Wave matches 1.. if entity @a[gamemode=!spectator,x=674,y=112,z=-1,dx=8,dy=6,dz=17,limit=1] unless entity @a[gamemode=!spectator,x=682.5,y=112,z=1.5,distance=..0.7,limit=1] run function luigis_mansion:room/normal/anteroom/wave_1
