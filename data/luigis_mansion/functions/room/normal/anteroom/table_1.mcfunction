execute if entity @a[advancements={luigis_mansion:mansion/anteroom_table_1=false},limit=1] positioned 674 114 16.0 run function luigis_mansion:spawn_entities/item/gold_bar
