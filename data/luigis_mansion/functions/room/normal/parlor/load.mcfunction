...
execute if entity @a[advancements={luigis_mansion:technical={found_e_gadd=false}},limit=1] positioned 684 113 6 run function luigis_mansion:blocks/unlit_candles
execute if entity @a[advancements={luigis_mansion:technical={found_e_gadd=false}},limit=1] positioned 684 113 9 run function luigis_mansion:blocks/unlit_candles
