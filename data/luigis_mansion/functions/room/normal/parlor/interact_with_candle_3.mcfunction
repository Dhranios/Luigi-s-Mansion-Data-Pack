execute if entity @s[x=690.5,y=112,z=3.5,distance=..0.7,tag=vacuum] unless score #parlor_candle_3 Search matches 1 run scoreboard players add #parlor_candle_3 Searching 1
execute if entity @s[x=690.5,y=112,z=3.5,distance=..0.7,tag=vacuum] run scoreboard players set #parlor_candle_3 Search 1
