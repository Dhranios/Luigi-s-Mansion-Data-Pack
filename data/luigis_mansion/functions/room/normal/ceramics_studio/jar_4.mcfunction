execute if entity @a[advancements={luigis_mansion:mansion/ceramics_studio_jar_4=false},limit=1] positioned 695 120 45 run function luigis_mansion:spawn_entities/item/red_ruby
