setblock 691 124 41 minecraft:stone_button[face=floor,powered=true]
setblock 690 120 46 minecraft:trapped_chest[facing=east,type=single]{LootTable:"luigis_mansion:search"}
