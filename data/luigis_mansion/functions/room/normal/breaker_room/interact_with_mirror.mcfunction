execute if entity @s[x=697.0,y=94,z=-31.0,dx=0,dy=1,dz=1,tag=vacuum] unless score #breaker_room_mirror Search matches 1 run scoreboard players add #breaker_room_mirror Searching 1
execute if entity @s[x=697.0,y=94,z=-31.0,dx=0,dy=1,dz=1,tag=vacuum] run scoreboard players set #breaker_room_mirror Search 1
