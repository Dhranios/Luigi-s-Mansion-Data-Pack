...
execute unless score #breaker_room Wave matches 100 run setblock 688 94 -31 minecraft:lever[face=wall,facing=east,powered=false]
execute if score #breaker_room Wave matches 100 if block 688 94 -31 minecraft:lever[face=wall,facing=east,powered=false] run function luigis_mansion:room/normal/breaker_room/end_blackout
