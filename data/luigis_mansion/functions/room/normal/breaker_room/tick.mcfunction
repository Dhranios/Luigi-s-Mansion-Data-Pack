...
execute if entity @a[advancements={luigis_mansion:mansion/breaker_room=false}] unless score #breaker_room Wave matches 1.. run function luigis_mansion:room/normal/breaker_room/wave_1
