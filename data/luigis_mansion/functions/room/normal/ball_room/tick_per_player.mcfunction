...
execute if entity @s[advancements={luigis_mansion:mansion/ball_room=false},tag=!blackout] unless entity @s[scores={MusicType=12..13}] unless entity @s[scores={MusicType=14}] unless entity @s[scores={MusicType=19}] unless entity @s[scores={MusicType=27..30}] unless entity @s[scores={MusicType=-1}] run function luigis_mansion:other/music/set/ball_room
