...
execute if entity @a[advancements={luigis_mansion:mansion/ball_room=false}] unless score #ball_room Wave matches 1.. run function luigis_mansion:room/normal/ball_room/wave_1
