...
execute positioned 684 114 -36.0 run function luigis_mansion:blocks/dust
scoreboard players set #sealed_room_mirror Searched 1
tag @e[x=684.5,y=114,z=-35.5,distance=..0.7,tag=ghost_marker] add spawn
tag @e[x=684.5,y=114,z=-35.5,distance=..0.7,tag=hidden_boo] add spawn