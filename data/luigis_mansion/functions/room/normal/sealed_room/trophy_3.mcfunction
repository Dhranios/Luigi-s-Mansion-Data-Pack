execute if entity @a[advancements={luigis_mansion:mansion/sealed_room_trophy_3=false},limit=1] positioned 693 114 -38 run function luigis_mansion:spawn_entities/item/gold_bar
