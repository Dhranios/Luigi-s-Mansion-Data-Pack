...
execute positioned 684 115 -15 run function luigis_mansion:blocks/unlit_candles
execute positioned 684 115 -19 run function luigis_mansion:blocks/unlit_candles
execute positioned 693 113 -20 run function luigis_mansion:blocks/unlit_candles
