execute if entity @s[x=710.5,y=102,z=47.5,distance=..0.7,tag=vacuum] unless score #butlers_room_chair_2 Search matches 1 run scoreboard players add #butlers_room_chair_2 Searching 1
execute if entity @s[x=710.5,y=102,z=47.5,distance=..0.7,tag=vacuum] run scoreboard players set #butlers_room_chair_2 Search 1
