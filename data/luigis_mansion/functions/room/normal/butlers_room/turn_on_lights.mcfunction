setblock 712 106 47 minecraft:stone_button[face=ceiling,powered=true]
setblock 715 102 49 minecraft:trapped_chest[facing=east,type=single]{LootTable:"luigis_mansion:search"}
