...
execute if entity @a[advancements={luigis_mansion:mansion/study=false}] unless score #study Wave matches 1.. run function luigis_mansion:room/normal/study/wave_1
