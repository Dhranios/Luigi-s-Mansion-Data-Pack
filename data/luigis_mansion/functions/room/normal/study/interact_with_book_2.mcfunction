execute if entity @s[x=690.5,y=112,z=23.5,distance=..0.7,tag=vacuum] unless score #study_book_2 Search matches 1 run scoreboard players add #study_book_2 Searching 1
execute if entity @s[x=690.5,y=112,z=23.5,distance=..0.7,tag=vacuum] run scoreboard players set #study_book_2 Search 1
