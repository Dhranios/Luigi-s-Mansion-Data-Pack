execute if entity @s[x=690.5,y=113,z=25.5,distance=..0.7,tag=vacuum] unless score #study_book_1 Search matches 1 run scoreboard players add #study_book_1 Searching 1
execute if entity @s[x=690.5,y=113,z=25.5,distance=..0.7,tag=vacuum] run scoreboard players set #study_book_1 Search 1
