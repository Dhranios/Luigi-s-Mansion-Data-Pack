execute if entity @a[advancements={luigis_mansion:mansion/balcony_2_plant_5=false},limit=1] positioned 680 122 36 run function luigis_mansion:spawn_entities/item/gold_bar
