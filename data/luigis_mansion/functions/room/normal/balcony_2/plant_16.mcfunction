execute if entity @a[advancements={luigis_mansion:mansion/balcony_2_plant_16=false},limit=1] positioned 679 121 -39 run function luigis_mansion:spawn_entities/item/green_emerald
