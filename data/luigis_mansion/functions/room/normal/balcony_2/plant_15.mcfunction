execute if entity @a[advancements={luigis_mansion:mansion/balcony_2_plant_15=false},limit=1] positioned 667 121 -40 run function luigis_mansion:spawn_entities/item/gold_bar
