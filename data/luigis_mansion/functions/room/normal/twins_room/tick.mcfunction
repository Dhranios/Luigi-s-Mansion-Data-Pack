...
execute if score #twins_room Wave matches 5 unless entity @e[tag=ghost,scores={Room=39},tag=!optional_ghost] run function luigis_mansion:room/normal/twins_room/clear
...
execute if entity @a[advancements={luigis_mansion:mansion/twins_room=false}] unless score #twins_room Wave matches 1.. run function luigis_mansion:room/normal/twins_room/wave_1
