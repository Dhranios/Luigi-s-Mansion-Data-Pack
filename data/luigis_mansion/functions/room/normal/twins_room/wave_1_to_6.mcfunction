...
execute unless score #orville LastHealth matches ..0 at @e[tag=me,limit=1] run function luigis_mansion:spawn_entities/portrait_ghost/orville
execute unless score #henry LastHealth matches ..0 at @e[tag=me,limit=1] run function luigis_mansion:spawn_entities/portrait_ghost/henry
