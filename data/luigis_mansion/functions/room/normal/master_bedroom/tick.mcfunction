...
execute if entity @a[advancements={luigis_mansion:mansion/master_bedroom=false}] unless score #master_bedroom Wave matches 1.. run function luigis_mansion:room/normal/master_bedroom/wave_1
