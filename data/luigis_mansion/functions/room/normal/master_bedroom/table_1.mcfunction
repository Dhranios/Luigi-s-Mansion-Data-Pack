execute if entity @a[advancements={luigis_mansion:mansion/master_bedroom_table_1=false},limit=1] positioned 695 112 55 run function luigis_mansion:spawn_entities/item/gold_bar
