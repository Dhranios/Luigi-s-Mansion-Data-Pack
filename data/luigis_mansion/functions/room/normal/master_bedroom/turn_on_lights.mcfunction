fill 689 118 49 690 118 48 minecraft:stone_button[face=floor,powered=true]
setblock 687 112 47 minecraft:trapped_chest[facing=east,type=single]{LootTable:"luigis_mansion:search"}
