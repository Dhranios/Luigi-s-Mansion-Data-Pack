execute if entity @a[advancements={luigis_mansion:mansion/master_bedroom_plant=false},limit=1] positioned 687 115 56 run function luigis_mansion:spawn_entities/item/green_emerald
