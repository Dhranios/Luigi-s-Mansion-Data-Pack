...
execute if entity @a[advancements={luigis_mansion:mansion/kitchen=false}] unless score #kitchen Wave matches 1.. run function luigis_mansion:room/normal/kitchen/wave_1
