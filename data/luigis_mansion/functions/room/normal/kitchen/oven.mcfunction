execute if entity @a[advancements={luigis_mansion:mansion/kitchen_oven=false},limit=1] positioned 689 102 40.0 run function luigis_mansion:spawn_entities/item/red_ruby
