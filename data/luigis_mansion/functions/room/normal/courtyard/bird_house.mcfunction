...
execute if score #temp Searched matches 1 run summon minecraft:item 647 104 -12 {Invulnerable:1b,Item:{id:"minecraft:brick",Count:1b,tag:{CustomModelData:7,luigis_mansion:{id:"luigis_mansion:marios_letter"},display:{Name:'{"italic":false,"color":"white","translate":"luigis_mansion:item.marios_letter"}'}}},Age:-32768s}
