execute if entity @a[advancements={luigis_mansion:mansion/courtyard_plant_3=false},limit=1] positioned 646 104 6 run function luigis_mansion:spawn_entities/item/green_emerald
