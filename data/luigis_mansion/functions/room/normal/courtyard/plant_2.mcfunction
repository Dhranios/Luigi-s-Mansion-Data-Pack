execute if entity @a[advancements={luigis_mansion:mansion/courtyard_plant_2=false},limit=1] positioned 650 104 15 run function luigis_mansion:spawn_entities/item/gold_bar
