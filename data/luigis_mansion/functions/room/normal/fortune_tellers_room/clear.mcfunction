...
execute if entity @a[tag=looking_at_map,limit=1] run function luigis_mansion:items/gameboy_horror/map/normal/fortune_tellers_room
function luigis_mansion:room/normal/fortune_tellers_room/remove_blockade
playsound luigis_mansion:block.chest.spawn block @a 711 102 -6 2
