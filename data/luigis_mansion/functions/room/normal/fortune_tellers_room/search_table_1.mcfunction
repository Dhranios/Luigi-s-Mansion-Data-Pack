...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 707 102 -4.0 run function luigis_mansion:blocks/dust
...
tag @e[x=707.5,y=102,z=-4.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=707.5,y=102,z=-4.5,distance=..0.7,tag=ghost_marker] add spawn