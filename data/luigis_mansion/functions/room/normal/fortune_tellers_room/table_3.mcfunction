execute if entity @a[advancements={luigis_mansion:mansion/fortune_tellers_room_table_3=false},limit=1] positioned 708 103 -20 run function luigis_mansion:spawn_entities/item/gold_bar
