execute if entity @a[advancements={luigis_mansion:mansion/guest_room_plant=false},limit=1] positioned 708 114 -38 run function luigis_mansion:spawn_entities/item/blue_sapphire
