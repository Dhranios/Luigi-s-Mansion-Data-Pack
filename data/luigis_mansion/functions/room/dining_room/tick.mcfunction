...
execute if score #dining_room Wave matches 1 unless entity @e[tag=ghost,scores={Room=22},tag=!optional_ghost] run function luigis_mansion:room/dining_room/clear
...
function #luigis_mansion:room/interactions/dining_room
