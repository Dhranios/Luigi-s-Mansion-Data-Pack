...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/butlers_room/bucket
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 717 102 57 run function luigis_mansion:blocks/dust
...
tag @e[x=717.5,y=102,z=57.5,distance=..0.7,tag=ghost_marker] add spawn