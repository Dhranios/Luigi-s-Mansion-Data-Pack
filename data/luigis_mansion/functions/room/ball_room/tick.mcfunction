...
execute if score #ball_room Wave matches 2 unless entity @e[tag=ghost,scores={Room=13},tag=!optional_ghost] run function luigis_mansion:room/ball_room/clear
execute if score #ball_room Wave matches 1 unless entity @e[tag=ghost,scores={Room=13},tag=!optional_ghost] run function luigis_mansion:room/ball_room/wave_2
...
function #luigis_mansion:room/interactions/ball_room
