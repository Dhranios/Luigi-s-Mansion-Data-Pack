execute if entity @a[advancements={luigis_mansion:mansion/butlers_room_bucket=false},limit=1] positioned 716 102 -40 run function luigis_mansion:spawn_entities/item/blue_sapphire
