...
execute unless data storage luigis_mansion:data current_state.current_data.room.roof{cleared:1b} if entity @a[tag=!blackout] unless score #roof Wave matches 1.. run function luigis_mansion:room/hidden/roof/wave_1
