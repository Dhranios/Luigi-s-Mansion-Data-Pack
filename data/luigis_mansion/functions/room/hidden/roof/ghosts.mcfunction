...
execute if entity @a[advancements={luigis_mansion:mansion/roof=false},tag=!blackout] unless score #roof Wave matches 1.. run function luigis_mansion:room/hidden/roof/wave_1
