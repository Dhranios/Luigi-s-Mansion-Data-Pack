...
execute if score #temp Searched matches 1 run summon minecraft:item 700 104 -38 {Invulnerable:1b,Item:{id:"minecraft:brick",Count:1b,tag:{CustomModelData:6,luigis_mansion:{id:"luigis_mansion:marios_hat"},display:{Name:'{"italic":false,"color":"white","translate":"luigis_mansion:item.marios_hat"}'}}},Age:-32768s}
