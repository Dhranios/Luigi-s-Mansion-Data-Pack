...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=706.0,y=93,z=41.5,nbt={SelectedItem:{tag:{luigis_mansion:{id:"luigis_mansion:key",room:"cellar"}}}}] run function luigis_mansion:room/normal/cellar/unlock_door
