...
execute if score #conservatory_chello Searched matches 1 if entity @s[scores={Time=0,MusicType=0}] run particle minecraft:note 662.0 104 6.0 0 0 0 1 1 normal @s
