execute if entity @a[advancements={luigis_mansion:mansion/sealed_room_trophy_1=false},limit=1] positioned 685 113 28 run function luigis_mansion:spawn_entities/item/gold_bar
