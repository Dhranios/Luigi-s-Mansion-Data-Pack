execute if entity @a[advancements={luigis_mansion:mansion/sealed_room_trophy_4=false},limit=1] positioned 697 114 53 run function luigis_mansion:spawn_entities/item/gold_bar
