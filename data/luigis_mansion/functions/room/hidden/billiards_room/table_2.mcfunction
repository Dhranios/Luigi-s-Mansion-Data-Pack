execute if entity @a[advancements={luigis_mansion:mansion/billiards_room_table_2=false},limit=1] positioned 681 103 -21 run function luigis_mansion:spawn_entities/item/gold_bar
