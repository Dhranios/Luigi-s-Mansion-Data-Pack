...
execute unless data storage luigis_mansion:data current_state.current_data.money_spawned{hidden_room_speedy_spirit:1b} positioned 713 102 -6 run function luigis_mansion:spawn_entities/new_ghost/speedy_spirit/hidden_room
