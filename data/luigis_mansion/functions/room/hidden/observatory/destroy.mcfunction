...
execute unless data storage luigis_mansion:data current_state.current_data.room.observatory{cleared:1b} positioned 679 119 63 run function luigis_mansion:spawn_entities/ghost/shining_ghost