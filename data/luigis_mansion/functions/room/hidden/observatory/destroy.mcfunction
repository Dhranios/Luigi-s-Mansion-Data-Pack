...
execute if entity @a[advancements={luigis_mansion:mansion/observatory=false},limit=1] positioned 679 119 63 run function luigis_mansion:spawn_entities/ghost/shining_ghost