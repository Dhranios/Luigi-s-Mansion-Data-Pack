summon minecraft:area_effect_cloud 700 111 15 {Tags:["choice","option_1"]}
summon minecraft:area_effect_cloud 700 111 8 {Tags:["choice","option_2"]}
summon minecraft:area_effect_cloud 700 111 -1 {Tags:["choice","option_3"]}
