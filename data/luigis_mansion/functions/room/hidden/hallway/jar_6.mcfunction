execute if entity @a[advancements={luigis_mansion:mansion/hallway_jar_6=false},limit=1] positioned 700 113.5 40 run function luigis_mansion:spawn_entities/item/gold_bar
