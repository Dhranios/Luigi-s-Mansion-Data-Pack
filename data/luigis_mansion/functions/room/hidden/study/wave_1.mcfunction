...
execute unless data storage luigis_mansion:data current_state.current_data.money_spawned{study_speedy_spirit:1b} positioned 688 111 -8 run function luigis_mansion:spawn_entities/new_ghost/speedy_spirit/study
