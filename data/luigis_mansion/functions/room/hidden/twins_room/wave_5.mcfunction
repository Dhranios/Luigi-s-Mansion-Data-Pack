execute if entity @a[advancements={luigis_mansion:mansion/twins_room_speedy_spirit=false},limit=1] positioned 709 114 -8 run function luigis_mansion:spawn_entities/new_ghost/speedy_spirit/twins_room
