...
execute if entity @a[advancements={luigis_mansion:mansion/twins_room=false},tag=!blackout] unless score #twins_room Wave matches 1.. run function luigis_mansion:room/hidden/twins_room/wave_1
