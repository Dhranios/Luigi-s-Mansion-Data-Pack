...
execute unless data storage luigis_mansion:data current_state.current_data.room.twins_room{cleared:1b} if entity @a[tag=!blackout] unless score #twins_room Wave matches 1.. run function luigis_mansion:room/hidden/twins_room/wave_1
