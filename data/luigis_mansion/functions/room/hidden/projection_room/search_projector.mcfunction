...
execute unless data storage luigis_mansion:data current_state.current_data.room.projection_room{cleared:1b} run setblock 684 103 10 minecraft:soul_torch
