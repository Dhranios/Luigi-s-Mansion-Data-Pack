execute if entity @a[advancements={luigis_mansion:mansion/parlor_lamp=false},limit=1] positioned 691.0 115 8.0 run function luigis_mansion:spawn_entities/item/gold_bar
