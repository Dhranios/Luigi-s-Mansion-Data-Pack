...
execute if entity @s[x=704,y=102,z=21,distance=..9,tag=!chance_check] if entity @s[advancements={luigis_mansion:mansion/main_hallway_gold_mouse=false}] unless entity @e[tag=gold_mouse,scores={Room=10},limit=1] run function luigis_mansion:room/hidden/main_hallway/gold_mouse
tag @s[x=704,y=102,z=21,distance=9..10,tag=chance_check] remove chance_check

execute at @s unless block ~ ~ ~ #minecraft:doors run playsound luigis_mansion:music.mansion.melody hostile @s[x=666,y=102,z=-9,dx=4,dy=6,dz=39,advancements={luigis_mansion:mansion/conservatory=false},scores={HallwayNoise=0}] ~ ~ ~ 1000
execute at @s unless block ~ ~ ~ #minecraft:doors run scoreboard players set @s[x=666,y=102,z=-9,dx=4,dy=6,dz=39,advancements={luigis_mansion:mansion/conservatory=false},scores={HallwayNoise=0}] HallwayNoise 850
...
execute at @s unless block ~ ~ ~ #minecraft:doors if entity @s[x=685,y=102,z=19,dx=14,dy=6,dz=4,advancements={luigis_mansion:mansion/dining_room=false}] at @s run function luigis_mansion:room/hidden/dining_room/noise
