...
execute positioned 700 122 -26.0 run function luigis_mansion:blocks/dust
scoreboard players set #armory_mirror Searched 1
tag @e[x=700.5,y=122,z=-25.5,distance=..0.7,tag=ghost_marker] add spawn
tag @e[x=700.5,y=122,z=-25.5,distance=..0.7,tag=hidden_boo] add spawn