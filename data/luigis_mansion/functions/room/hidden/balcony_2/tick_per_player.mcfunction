...
execute if entity @s[x=681.5,y=120,z=-13.0,distance=..4] if entity @a[nbt={Inventory:[{tag:{luigis_mansion:{id:"luigis_mansion:key",room:"attic_hallway_2"}}}]}] run function luigis_mansion:room/hidden/balcony_2/clear_blockade
