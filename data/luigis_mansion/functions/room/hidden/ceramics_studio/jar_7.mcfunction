execute if entity @a[advancements={luigis_mansion:mansion/ceramics_studio_jar_7=false},limit=1] positioned 688 120 -24 run function luigis_mansion:spawn_entities/item/gold_bar
