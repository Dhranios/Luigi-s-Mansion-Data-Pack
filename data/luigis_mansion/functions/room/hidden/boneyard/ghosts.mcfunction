...
execute if entity @a[advancements={luigis_mansion:mansion/boneyard=false},tag=!blackout] unless score #boneyard Wave matches 1.. run function luigis_mansion:room/hidden/boneyard/wave_1
