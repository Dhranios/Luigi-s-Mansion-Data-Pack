execute if entity @a[advancements={luigis_mansion:mansion/cellar_shelf_2=false},limit=1] positioned 713 96 46 run function luigis_mansion:spawn_entities/item/gold_bar
