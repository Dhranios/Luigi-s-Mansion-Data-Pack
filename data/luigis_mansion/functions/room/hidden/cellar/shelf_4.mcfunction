execute if entity @a[advancements={luigis_mansion:mansion/cellar_shelf_4=false},limit=1] positioned 714 93 54 run function luigis_mansion:spawn_entities/item/gold_bar
