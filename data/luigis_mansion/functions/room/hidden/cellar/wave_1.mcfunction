...
execute unless data storage luigis_mansion:data current_state.current_data.money_spawned{cellar_speedy_spirit:1b} positioned 709 94 39 run function luigis_mansion:spawn_entities/new_ghost/speedy_spirit/cellar
