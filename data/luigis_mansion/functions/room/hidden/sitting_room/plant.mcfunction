execute if entity @a[advancements={luigis_mansion:mansion/sitting_room_plant=false},limit=1] positioned 709 114 20 run function luigis_mansion:spawn_entities/item/gold_bar
