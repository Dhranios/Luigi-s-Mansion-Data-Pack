execute if entity @a[advancements={luigis_mansion:mansion/tea_room_drawer_2=false},limit=1] positioned 659 112 54 run function luigis_mansion:spawn_entities/item/red_ruby
