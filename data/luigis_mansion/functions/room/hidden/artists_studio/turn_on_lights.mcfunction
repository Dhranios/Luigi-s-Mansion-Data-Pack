execute unless data storage luigis_mansion:data current_state.current_data.used_keys{secret_altar:1b} run summon minecraft:armor_stand 696 120.2 50 {Pose:{Head:[0.0f,-180.0f,0.01f]},Marker:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:5,CustomModelData:19}}],Small:1b,Tags:["item","key","secret_altar","rotated"],Rotation:[180.0f,0.0f],DisabledSlots:2039583}
...
execute if data storage luigis_mansion:data current_state.current_data.technical_data{released_boos_talk:1b} if entity @a[scores={Boos=..49},limit=1] run function luigis_mansion:room/hidden/artists_studio/load_boos
