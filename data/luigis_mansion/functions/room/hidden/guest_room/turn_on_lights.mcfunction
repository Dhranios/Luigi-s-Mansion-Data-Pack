execute if data storage luigis_mansion:data current_state.current_data.technical_data{released_boos_talk:1b} if data storage luigis_mansion:data current_state.current_data.rooms.guest_room{cleared:1b} if entity @a[scores={Boos=..49},limit=1] run function luigis_mansion:room/hidden/guest_room/load_boos
