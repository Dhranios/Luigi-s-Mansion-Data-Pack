...
execute unless data storage luigis_mansion:data current_state.current_data.money_spawned{storage_room_speedy_spirit:1b} positioned 679 102 55 run function luigis_mansion:spawn_entities/new_ghost/speedy_spirit/storage_room
