execute if entity @a[advancements={luigis_mansion:mansion/balcony_1_plant_4=false},limit=1] positioned 674 112 -24 run function luigis_mansion:spawn_entities/item/gold_bar
