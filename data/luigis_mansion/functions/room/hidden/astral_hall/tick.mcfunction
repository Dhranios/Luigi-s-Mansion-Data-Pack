...
execute if entity @a[advancements={luigis_mansion:mansion/astral_hall=false},limit=1] unless block 677 111 47 minecraft:iron_door[powered=true] run scoreboard players set #temp Searched 1
...
execute as @a[x=677,y=111,z=46,dx=0,dy=1,dz=0,advancements={luigis_mansion:mansion/astral_hall=false}] at @s run function luigis_mansion:room/hidden/astral_hall/trick_door
