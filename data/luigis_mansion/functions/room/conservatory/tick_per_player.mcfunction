...
execute if score #conservatory_saxophone Searched matches 1 if entity @s[scores={Time=0}] run particle minecraft:note 659 104 14 0 0 0 1 1
...
execute if score #conservatory_harp Searched matches 1 if entity @s[scores={Time=0}] run particle minecraft:note 657.0 105 12.0 0 0 0 1 1
...
execute if score #conservatory_chello Searched matches 1 if entity @s[scores={Time=0}] run particle minecraft:note 661.0 104 9.0 0 0 0 1 1
...
execute if score #conservatory_drum_1 Searched matches 1 if entity @s[scores={Time=0}] run particle minecraft:note 657 103 5 0 0 0 1 1
...
execute if score #conservatory_drum_2 Searched matches 1 if entity @s[scores={Time=0}] run particle minecraft:note 658 103 3 0 0 0 1 1
...
execute if score #conservatory_drum_3 Searched matches 1 if entity @s[scores={Time=0}] run particle minecraft:note 657 103 1 0 0 0 1 1
...
execute if score #conservatory_xylophone Searched matches 1 if entity @s[scores={Time=0}] run particle minecraft:note 661 103 2 0 0 0 1 1
