...
execute if score #conservatory Wave matches 4 unless entity @e[tag=ghost,scores={Room=21},tag=!optional_ghost] run function luigis_mansion:room/conservatory/clear
...
function #luigis_mansion:room/interactions/conservatory
