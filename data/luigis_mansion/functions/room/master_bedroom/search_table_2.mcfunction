...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/master_bedroom/table_2
...
data remove block 695 112 41 {LootTable:"luigis_mansion:search"}
data remove block 694 112 41 {LootTable:"luigis_mansion:search"}
